...
//
//---------------------------------------------------------------------------
void CDXLTranslateContextBaseTable::SetOID(OID oid) {
...
//
//---------------------------------------------------------------------------
void CDXLTranslateContextBaseTable::SetRelIndex(Index rel_index) {
...
//
//---------------------------------------------------------------------------
OID CDXLTranslateContextBaseTable::GetOid() const {
  return m_oid;
}
...
//
//---------------------------------------------------------------------------
Index CDXLTranslateContextBaseTable::GetRelIndex() const {
...
//
//---------------------------------------------------------------------------
INT CDXLTranslateContextBaseTable::GetAttnoForColId(ULONG colid) const {
...
//
//---------------------------------------------------------------------------
BOOL CDXLTranslateContextBaseTable::InsertMapping(ULONG dxl_colid, INT att_no) {
  // copy key and value
