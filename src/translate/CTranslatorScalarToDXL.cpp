...
//---------------------------------------------------------------------------
CTranslatorScalarToDXL::CTranslatorScalarToDXL(CMemoryPool *mp, CMDAccessor *mda)
    : m_context(nullptr),
      m_mp(mp),
      m_md_accessor(mda),
      m_query_level(0),
...
//---------------------------------------------------------------------------
CTranslatorQueryToDXL *CTranslatorScalarToDXL::CreateSubqueryTranslator(Query *subquery,
  ...
  return GPOS_NEW(m_context->m_mp)
      CTranslatorQueryToDXL(m_context, m_md_accessor, var_colid_mapping, subquery, m_query_level + 1,
                            false,  // is_top_query_dml
                            m_cte_entries);
}

CDXLNode *CTranslatorScalarToDXL::TranslateStandaloneExprToDXL(CMemoryPool *mp, CMDAccessor *mda,
                                                               const CMappingVarColId *var_colid_mapping,
                                                               const Expr *expr) {
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateVarToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
  ...
  if (var->varattno != 0 || EpspotIndexScan == m_op_type || EpspotIndexOnlyScan == m_op_type) {
    ...
    if (m_context == nullptr) {
      GPOS_RAISE(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLUnsupportedFeature,
                 GPOS_WSZ_LIT("Var with no existing mapping in a stand-alone context"));
    }
  ...
  CDXLColRef *dxl_colref = GPOS_NEW(m_mp)
      CDXLColRef(mdname, id, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, var->vartype), var->vartypmod);

  // create the scalar ident operator
  CDXLScalarIdent *scalar_ident = GPOS_NEW(m_mp) CDXLScalarIdent(m_mp, dxl_colref);
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateParamToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
  GPOS_ASSERT(IsA(expr, Param));
  const Param *param = (Param *)expr;

  CDXLScalarParam *scalar_param = GPOS_NEW(m_mp) CDXLScalarParam(
      m_mp, param->paramid, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, param->paramtype), param->paramtypmod);
...
//		is responsible for freeing it
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateScalarToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
  ...
  switch (tag) {
    ...
    case T_Param: {
      if (!true) {
        GPOS_RAISE(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLUnsupportedFeature,
                   GPOS_WSZ_LIT("Use optimizer_enable_query_parameter to enable Orca with query parameters"));
      }
      return CTranslatorScalarToDXL::TranslateParamToDXL(expr, var_colid_mapping);
    }
    case T_Var: {
      return CTranslatorScalarToDXL::TranslateVarToDXL(expr, var_colid_mapping);
    }
    case T_OpExpr: {
      return CTranslatorScalarToDXL::TranslateOpExprToDXL(expr, var_colid_mapping);
    }
    case T_ScalarArrayOpExpr: {
      return CTranslatorScalarToDXL::TranslateScalarArrayOpExprToDXL(expr, var_colid_mapping);
    }
    case T_DistinctExpr: {
      return CTranslatorScalarToDXL::TranslateDistinctExprToDXL(expr, var_colid_mapping);
    }
    case T_Const: {
      return CTranslatorScalarToDXL::TranslateConstToDXL(expr, var_colid_mapping);
    }
    case T_BoolExpr: {
      return CTranslatorScalarToDXL::TranslateBoolExprToDXL(expr, var_colid_mapping);
    }
    case T_BooleanTest: {
      return CTranslatorScalarToDXL::TranslateBooleanTestToDXL(expr, var_colid_mapping);
    }
    case T_CaseExpr: {
      return CTranslatorScalarToDXL::TranslateCaseExprToDXL(expr, var_colid_mapping);
    }
    case T_CaseTestExpr: {
      return CTranslatorScalarToDXL::TranslateCaseTestExprToDXL(expr, var_colid_mapping);
    }
    case T_CoalesceExpr: {
      return CTranslatorScalarToDXL::TranslateCoalesceExprToDXL(expr, var_colid_mapping);
    }
    case T_MinMaxExpr: {
      return CTranslatorScalarToDXL::TranslateMinMaxExprToDXL(expr, var_colid_mapping);
    }
    case T_FuncExpr: {
      return CTranslatorScalarToDXL::TranslateFuncExprToDXL(expr, var_colid_mapping);
    }
    case T_Aggref: {
      return CTranslatorScalarToDXL::TranslateAggrefToDXL(expr, var_colid_mapping);
    }
    case T_WindowFunc: {
      return CTranslatorScalarToDXL::TranslateWindowFuncToDXL(expr, var_colid_mapping);
    }
    case T_NullTest: {
      return CTranslatorScalarToDXL::TranslateNullTestToDXL(expr, var_colid_mapping);
    }
    case T_NullIfExpr: {
      return CTranslatorScalarToDXL::TranslateNullIfExprToDXL(expr, var_colid_mapping);
    }
    case T_RelabelType: {
      return CTranslatorScalarToDXL::TranslateRelabelTypeToDXL(expr, var_colid_mapping);
    }
    case T_CoerceToDomain: {
      return CTranslatorScalarToDXL::TranslateCoerceToDomainToDXL(expr, var_colid_mapping);
    }
    case T_CoerceViaIO: {
      return CTranslatorScalarToDXL::TranslateCoerceViaIOToDXL(expr, var_colid_mapping);
    }
    case T_ArrayCoerceExpr: {
      return CTranslatorScalarToDXL::TranslateArrayCoerceExprToDXL(expr, var_colid_mapping);
    }
    case T_SubLink: {
      return CTranslatorScalarToDXL::TranslateSubLinkToDXL(expr, var_colid_mapping);
    }
    case T_ArrayExpr: {
      return CTranslatorScalarToDXL::TranslateArrayExprToDXL(expr, var_colid_mapping);
    }
    case T_SubscriptingRef: {
      return CTranslatorScalarToDXL::TranslateArrayRefToDXL(expr, var_colid_mapping);
    }
    case T_SortGroupClause: {
      return CTranslatorScalarToDXL::TranslateSortGroupClauseToDXL(expr, var_colid_mapping);
    }
    case T_FieldSelect: {
      return CTranslatorScalarToDXL::TranslateFieldSelectToDXL(expr, var_colid_mapping);
    }
  }
}
...
//		is responsible for freeing it
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateDistinctExprToDXL(const Expr *expr,
                                                             const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLNode *left_node = TranslateScalarToDXL((Expr *)gpdb::ListNth(distinct_expr->args, 0), var_colid_mapping);
  ...
  CDXLScalarDistinctComp *dxlop =
      GPOS_NEW(m_mp) CDXLScalarDistinctComp(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, distinct_expr->opno));
...
//		is responsible for freeing it
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::CreateScalarCmpFromOpExpr(const Expr *expr,
                                                            const CMappingVarColId *var_colid_mapping) {
  ...
  CMDIdGPDB *mdid = GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, op_expr->opno);
...
//		is responsible for freeing it
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateOpExprToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
  GPOS_ASSERT(IsA(expr, OpExpr));
  ...
  CDXLScalarOpExpr *dxlop =
      GPOS_NEW(m_mp) CDXLScalarOpExpr(m_mp, mdid, return_type_mdid, GPOS_NEW(m_mp) CWStringConst(str->GetBuffer()));
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateNullIfExprToDXL(const Expr *expr,
                                                           const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLScalarNullIf *dxlop =
      GPOS_NEW(m_mp) CDXLScalarNullIf(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, null_if_expr->opno),
                                      GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, null_if_expr->opresulttype));
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateScalarArrayOpExprToDXL(const Expr *expr,
                                                                  const CMappingVarColId *var_colid_mapping) {
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::CreateScalarArrayCompFromExpr(const Expr *expr,
                                                                const CMappingVarColId *var_colid_mapping) {
  ...
  // get operator name
  CMDIdGPDB *mdid_op = GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, scalar_array_op_expr->opno);
  ...
  CDXLScalarArrayComp *dxlop = GPOS_NEW(m_mp)
      CDXLScalarArrayComp(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, scalar_array_op_expr->opno),
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateConstToDXL(const Expr *expr,
                                                      const CMappingVarColId *  // var_colid_mapping
) {
  ...
  CDXLNode *dxlnode =
      GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarConstValue(m_mp, TranslateConstToDXL(constant)));
...
//---------------------------------------------------------------------------
CDXLDatum *CTranslatorScalarToDXL::TranslateConstToDXL(CMemoryPool *mp, CMDAccessor *mda, const Const *constant) {
  CMDIdGPDB *mdid = GPOS_NEW(mp) CMDIdGPDB(IMDId::EmdidGeneral, constant->consttype);
  ...
  CDXLDatum *datum_dxl = CTranslatorScalarToDXL::TranslateDatumToDXL(
      mp, md_type, constant->consttypmod, constant->constisnull, constant->constlen, constant->constvalue);
...
//		Create a DXL datum from a GPDB Const
//---------------------------------------------------------------------------
CDXLDatum *CTranslatorScalarToDXL::TranslateConstToDXL(const Const *constant) const {
...
//		is responsible for freeing it
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateBoolExprToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
...
//		is responsible for freeing it
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateBooleanTestToDXL(const Expr *expr,
                                                            const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLNode *dxlnode = GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarBooleanTest(m_mp, type));
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateNullTestToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateCoalesceExprToDXL(const Expr *expr,
                                                             const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLScalarCoalesce *dxlop = GPOS_NEW(m_mp)
      CDXLScalarCoalesce(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, coalesce_expr->coalescetype));
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateMinMaxExprToDXL(const Expr *expr,
                                                           const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLScalarMinMax *dxlop = GPOS_NEW(m_mp)
      CDXLScalarMinMax(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, min_max_expr->minmaxtype), min_max_type);
...
//		is responsible for freeing it
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateCaseExprToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
...
//
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::CreateScalarSwitchFromCaseExpr(const CaseExpr *case_expr,
                                                                 const CMappingVarColId *var_colid_mapping) {
  GPOS_ASSERT(nullptr != case_expr->arg);

  CDXLScalarSwitch *dxlop =
      GPOS_NEW(m_mp) CDXLScalarSwitch(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, case_expr->casetype));
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateCaseTestExprToDXL(const Expr *expr,
                                                             const CMappingVarColId *  // var_colid_mapping
) {
  GPOS_ASSERT(IsA(expr, CaseTestExpr));
  const CaseTestExpr *case_test_expr = (CaseTestExpr *)expr;
  CDXLScalarCaseTest *dxlop =
      GPOS_NEW(m_mp) CDXLScalarCaseTest(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, case_test_expr->typeId));
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateRelabelTypeToDXL(const Expr *expr,
                                                            const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLNode *dxlnode = GPOS_NEW(m_mp) CDXLNode(
      m_mp, GPOS_NEW(m_mp) CDXLScalarCast(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, relabel_type->resulttype),
                                          GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, 0)  // casting function oid
                                          ));
  dxlnode->AddChild(child_node);
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateCoerceToDomainToDXL(const Expr *expr,
                                                               const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLNode *dxlnode = GPOS_NEW(m_mp)
      CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarCoerceToDomain(
                         m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, coerce->resulttype), coerce->resulttypmod,
...
//             GPDB coerce expression
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateCoerceViaIOToDXL(const Expr *expr,
                                                            const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLNode *dxlnode = GPOS_NEW(m_mp)
      CDXLNode(m_mp, GPOS_NEW(m_mp)
                         CDXLScalarCoerceViaIO(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, coerce->resulttype),
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateArrayCoerceExprToDXL(const Expr *expr,
                                                                const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLNode *elemexpr_node = TranslateScalarToDXL(array_coerce_expr->elemexpr, var_colid_mapping);

  GPOS_ASSERT(nullptr != child_node);
  GPOS_ASSERT(nullptr != elemexpr_node);

  CDXLNode *dxlnode = GPOS_NEW(m_mp)
      CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarArrayCoerceExpr(
                         m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, array_coerce_expr->resulttype),
                         array_coerce_expr->resulttypmod, (EdxlCoercionForm)array_coerce_expr->coerceformat,
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateFieldSelectToDXL(const Expr *expr,
                                                            const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLNode *child_node = TranslateScalarToDXL(fieldselect->arg, var_colid_mapping);
  GPOS_ASSERT(nullptr != child_node);

  // create the DXL node holding the scalar boolean operator
  CDXLNode *dxlnode = GPOS_NEW(m_mp) CDXLNode(
      m_mp,
      GPOS_NEW(m_mp) CDXLScalarFieldSelect(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, fieldselect->resulttype),
                                           GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, fieldselect->resultcollid),
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateFuncExprToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
  GPOS_ASSERT(IsA(expr, FuncExpr));
  const FuncExpr *func_expr = (FuncExpr *)expr;
  int32 type_modifier = gpdb::ExprTypeMod((Node *)expr);

  CMDIdGPDB *mdid_func = GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, func_expr->funcid);

  // create the DXL node holding the scalar funcexpr.
  CDXLNode *dxlnode = GPOS_NEW(m_mp)
      CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarFuncExpr(
                         m_mp, mdid_func, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, func_expr->funcresulttype),
...
CDXLNode *CTranslatorScalarToDXL::TranslateAggrefToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
  ...
  if (aggref->aggorder != NIL && GPOS_FTRACE(EopttraceDisableOrderedAgg)) {
    GPOS_RAISE(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLUnsupportedFeature,
               GPOS_WSZ_LIT("Ordered aggregates disabled. Enable by setting optimizer_enable_orderedagg=on"));
  }
  ...
  IMDId *mdid_return_type =
      CScalarAggFunc::PmdidLookupReturnType(agg_mdid, (EdxlaggstageNormal == agg_stage), m_md_accessor);
  ...
  if (m_md_accessor->RetrieveType(mdid_return_type)->IsAmbiguous()) {
    ...
    resolved_ret_type = GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, aggref->aggtype);
  }
  ...
  CDXLScalarAggref *aggref_scalar =
      GPOS_NEW(m_mp) CDXLScalarAggref(m_mp, agg_mdid, resolved_ret_type, is_distinct, agg_stage,
  ...
  foreach (lc, aggref->aggorder) {
    ...
    // mapping.
    ((SortGroupClause *)expr)->tleSortGroupRef = indexes[((SortGroupClause *)expr)->tleSortGroupRef];
...
//---------------------------------------------------------------------------
CDXLWindowFrame *CTranslatorScalarToDXL::TranslateWindowFrameToDXL(int frame_options, const Node *start_offset,
                                                                   const Node *end_offset, Oid start_in_range_func,
                                                                   Oid end_in_range_func, Oid in_range_coll,
  ...
  if ((frame_options & FRAMEOPTION_ROWS) != 0) {
    ...
    GPOS_RAISE(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLUnsupportedFeature, GPOS_WSZ_LIT("window frame option"));
  }
  ...
  CDXLNode *lead_edge = GPOS_NEW(m_mp)
      CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarWindowFrameEdge(m_mp, true /* fLeading */, leading_boundary));
  CDXLNode *trail_edge = GPOS_NEW(m_mp)
      CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarWindowFrameEdge(m_mp, false /* fLeading */, trailing_boundary));

  // translate the lead and trail value
  if (nullptr != start_offset) {
    lead_edge->AddChild(TranslateWindowFrameEdgeToDXL(start_offset, var_colid_mapping, new_scalar_proj_list));
  }

  if (nullptr != end_offset) {
    trail_edge->AddChild(TranslateWindowFrameEdgeToDXL(end_offset, var_colid_mapping, new_scalar_proj_list));
  }

  CDXLWindowFrame *window_frame_dxl =
      GPOS_NEW(m_mp) CDXLWindowFrame(frame_spec, strategy, lead_edge, trail_edge, start_in_range_func,
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateWindowFrameEdgeToDXL(const Node *node,
                                                                const CMappingVarColId *var_colid_mapping,
                                                                CDXLNode *new_scalar_proj_list) {
  ...
  if (!IsA(node, Var) && !IsA(node, Const)) {
    ...
    CDXLNode *project_element_node =
        GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarProjElem(m_mp, project_element_id, alias_mdname));
    ...
    CDXLScalarIdent *scalar_ident = GPOS_NEW(m_mp) CDXLScalarIdent(
        m_mp, GPOS_NEW(m_mp)
                  CDXLColRef(GPOS_NEW(m_mp) CMDName(m_mp, &unnamed_col), project_element_id,
                             GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, gpdb::ExprType(const_cast<Node *>(node))),
...
//
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateWindowFuncToDXL(const Expr *expr,
                                                           const CMappingVarColId *var_colid_mapping) {
   ...
   * be set correctly.
   */
  CDXLScalarWindowRef *winref_dxlop = GPOS_NEW(m_mp)
      CDXLScalarWindowRef(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, window_func->winfnoid),
                          GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, window_func->wintype), false,
                          window_func->winstar, window_func->winagg, EdxlwinstageImmediate, win_spec_pos);
...
//		is responsible for freeing it
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::CreateFilterFromQual(List *quals, const CMappingVarColId *var_colid_mapping,
...
//
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateSubLinkToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::CreateQuantifiedSubqueryFromSublink(const SubLink *sublink,
                                                                      const CMappingVarColId *var_colid_mapping) {
  CAutoP<CTranslatorQueryToDXL> query_to_dxl_translator;
  query_to_dxl_translator = CreateSubqueryTranslator((Query *)sublink->subselect, var_colid_mapping);
  ...
  if (ALL_SUBLINK == sublink->subLinkType) {
    subquery = GPOS_NEW(m_mp) CDXLScalarSubqueryAll(m_mp, mdid, GPOS_NEW(m_mp) CMDName(m_mp, str), colid);
  } else {
    subquery = GPOS_NEW(m_mp) CDXLScalarSubqueryAny(m_mp, mdid, GPOS_NEW(m_mp) CMDName(m_mp, str), colid);
  }
...
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::CreateScalarSubqueryFromSublink(const SubLink *sublink,
                                                                  const CMappingVarColId *var_colid_mapping) {
...
//
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateArrayExprToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
  GPOS_ASSERT(IsA(expr, ArrayExpr));

  const ArrayExpr *parrayexpr = (ArrayExpr *)expr;

  CDXLScalarArray *dxlop = GPOS_NEW(m_mp)
      CDXLScalarArray(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, parrayexpr->element_typeid),
                      GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, parrayexpr->array_typeid), parrayexpr->multidims);
...
//
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::TranslateArrayRefToDXL(const Expr *expr, const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLScalarArrayRef *dxlop = GPOS_NEW(m_mp)
      CDXLScalarArrayRef(m_mp, GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, parrayref->refelemtype), type_modifier,
                         GPOS_NEW(m_mp) CMDIdGPDB(IMDId::EmdidGeneral, parrayref->refcontainertype),
...
CDXLNode *CTranslatorScalarToDXL::TranslateSortGroupClauseToDXL(const Expr *expr,
                                                                const CMappingVarColId *var_colid_mapping) {
  ...
  CDXLScalarSortGroupClause *sort_group_clause = GPOS_NEW(m_mp)
      CDXLScalarSortGroupClause(m_mp, sgc->tleSortGroupRef, sgc->eqop, sgc->sortop, sgc->nulls_first, sgc->hashable);
...
//
//---------------------------------------------------------------------------
void CTranslatorScalarToDXL::AddArrayIndexList(CDXLNode *dxlnode, List *list,
  ...
  CDXLNode *index_list_dxlnode =
      GPOS_NEW(m_mp) CDXLNode(m_mp, GPOS_NEW(m_mp) CDXLScalarArrayRefIndexList(m_mp, index_list_bound));
...
//
//---------------------------------------------------------------------------
const CWStringConst *CTranslatorScalarToDXL::GetDXLArrayCmpType(IMDId *mdid) const {
  // get operator name
...
//		sublink node
//---------------------------------------------------------------------------
CDXLNode *CTranslatorScalarToDXL::CreateExistSubqueryFromSublink(const SubLink *sublink,
                                                                 const CMappingVarColId *var_colid_mapping) {
...
CDXLDatum *CTranslatorScalarToDXL::TranslateDatumToDXL(CMemoryPool *mp, const IMDType *md_type, INT type_modifier,
  ...
  switch (md_type->GetDatumType()) {
    ...
    case IMDType::EtiInt2: {
      return CTranslatorScalarToDXL::TranslateInt2DatumToDXL(mp, md_type, is_null, len, datum);
    }
    case IMDType::EtiInt4: {
      return CTranslatorScalarToDXL::TranslateInt4DatumToDXL(mp, md_type, is_null, len, datum);
    }
    case IMDType::EtiInt8: {
      return CTranslatorScalarToDXL::TranslateInt8DatumToDXL(mp, md_type, is_null, len, datum);
    }
    case IMDType::EtiBool: {
      return CTranslatorScalarToDXL::TranslateBoolDatumToDXL(mp, md_type, is_null, len, datum);
    }
    case IMDType::EtiOid: {
      return CTranslatorScalarToDXL::TranslateOidDatumToDXL(mp, md_type, is_null, len, datum);
    }
  }
}
...
CDXLDatum *CTranslatorScalarToDXL::TranslateGenericDatumToDXL(CMemoryPool *mp, const IMDType *md_type,
  ...
  if (CMDTypeGenericGPDB::HasByte2IntMapping(md_type)) {
    ...
    lint_value = ExtractLintValueFromDatum(md_type, is_null, bytes, length, base_mdid);
    base_mdid->Release();
  }

  return CMDTypeGenericGPDB::CreateDXLDatumVal(mp, mdid, md_type, type_modifier, is_null, bytes, length, lint_value,
                                               double_value);
}
...
LINT CTranslatorScalarToDXL::ExtractLintValueFromDatum(const IMDType *md_type, BOOL is_null, BYTE *bytes, ULONG length,
  ...
  if (mdid->Equals(&CMDIdGPDB::m_mdid_cash) || mdid->Equals(&CMDIdGPDB::m_mdid_date)) {
    ...
    if (is_null) {
      ...
      if (mdid->Equals(&CMDIdGPDB::m_mdid_uuid)) {
        hash = gpdb::UUIDHash((Datum)bytes);
                 ...
                 (base_mdid->IsValid() && base_mdid->Equals(&CMDIdGPDB::m_mdid_bpchar))) {
        hash = gpdb::HashBpChar((Datum)bytes);
      } else if (mdid->Equals(&CMDIdGPDB::m_mdid_char) ||
                 (base_mdid->IsValid() && base_mdid->Equals(&CMDIdGPDB::m_mdid_char))) {
        hash = gpdb::HashChar((Datum)bytes);
      } else if (mdid->Equals(&CMDIdGPDB::m_mdid_name) ||
                 (base_mdid->IsValid() && base_mdid->Equals(&CMDIdGPDB::m_mdid_name))) {
...
IDatum *CTranslatorScalarToDXL::CreateIDatumFromGpdbDatum(CMemoryPool *mp, const IMDType *md_type, BOOL is_null,
  ...
  CDXLDatum *datum_dxl = CTranslatorScalarToDXL::TranslateDatumToDXL(mp, md_type, gpmd::default_type_modifier, is_null,
                                                                     length, gpdb_datum);
