...
using ULongToTargetEntryMap =
    CHashMap<ULONG, TargetEntry, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>, CleanupNULL>;
// hash maps mapping ULONG -> CMappingElementColIdParamId
using ULongToColParamMap = CHashMap<ULONG, CMappingElementColIdParamId, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
                                    CleanupDelete<ULONG>, CleanupRelease<CMappingElementColIdParamId>>;

using ULongToColParamMapIter =
    CHashMapIter<ULONG, CMappingElementColIdParamId, gpos::HashValue<ULONG>, gpos::Equals<ULONG>, CleanupDelete<ULONG>,
...
class CDXLTranslateContext {
 ...
 public:
  ...
  // ctor/dtor
  CDXLTranslateContext(CMemoryPool *mp, BOOL is_child_agg_node, const Query *query);
  ...
  ULongToColParamMap *GetColIdToParamIdMap() { return m_colid_to_paramid_map; }
