...
class CTranslatorRelcacheToDXL {
 private:
  ...
  static IMDCacheObject *RetrieveObjectGPDB(CMemoryPool *mp, IMDId *mdid, IMDCacheObject::Emdtype mdtype);
  ...
  static IMDCacheObject *RetrieveColStats(CMemoryPool *mp, CMDAccessor *md_accessor, IMDId *mdid);
  ...
  static CMDIndexInfoArray *RetrieveRelIndexInfo(CMemoryPool *mp, Relation rel);
  ...
  static IMdIdArray *RetrieveIndexOpFamilies(CMemoryPool *mp, IMDId *mdid_index);

  // generate statistics for the system level columns
  static CDXLColStats *GenerateStatsForSystemCols(CMemoryPool *mp, const IMDRelation *md_rel,
                                                  CMDIdColStats *mdid_col_stats, CMDName *md_colname,
                                                  IMDId *mdid_atttype, AttrNumber attrnum,
 ...
 public:
  ...
  static IMDCacheObject *RetrieveObject(CMemoryPool *mp, CMDAccessor *md_accessor, IMDId *mdid,
  ...
  static IMDRelation *RetrieveRel(CMemoryPool *mp, CMDAccessor *md_accessor, IMDId *mdid);

  // add system columns (oid, tid, xmin, etc) in table descriptors
  static void AddSystemColumns(CMemoryPool *mp, CMDColumnArray *mdcol_array, Relation rel);

  // retrieve an index from the relcache
  static IMDIndex *RetrieveIndex(CMemoryPool *mp, CMDAccessor *md_accessor, IMDId *mdid_index);
