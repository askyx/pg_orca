...
class CXformIndexOnlyGet2IndexOnlyScan : public CXformImplementation {
 private:
 public:
  CXformIndexOnlyGet2IndexOnlyScan(const CXformIndexOnlyGet2IndexOnlyScan &) = delete;
  ...
  // ident accessors
  EXformId Exfid() const override { return ExfIndexOnlyGet2IndexOnlyScan; }

  // xform name
  const char *SzId() const override { return "CXformIndexOnlyGet2IndexOnlyScan"; }
