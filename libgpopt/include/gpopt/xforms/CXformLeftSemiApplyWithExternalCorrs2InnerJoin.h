...
class CXformLeftSemiApplyWithExternalCorrs2InnerJoin
 ...
 public:
  CXformLeftSemiApplyWithExternalCorrs2InnerJoin(const CXformLeftSemiApplyWithExternalCorrs2InnerJoin &) = delete;
  ...
  CXformLeftSemiApplyWithExternalCorrs2InnerJoin(CMemoryPool *mp, CExpression *pexprPattern)
