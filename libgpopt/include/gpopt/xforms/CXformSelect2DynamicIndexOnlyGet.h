...
class CXformSelect2DynamicIndexOnlyGet : public CXformExploration {
 public:
  ...
  CXformSelect2DynamicIndexOnlyGet(const CXformSelect2DynamicIndexOnlyGet &) = delete;

  // dtor
  ~CXformSelect2DynamicIndexOnlyGet() override = default;

  // ident accessors
  EXformId Exfid() const override { return ExfSelect2DynamicIndexOnlyGet; }

  // xform name
  const CHAR *SzId() const override { return "CXformSelect2DynamicIndexOnlyGet"; }
