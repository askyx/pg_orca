...
class CXformLeftSemiApplyIn2LeftSemiJoin : public CXformLeftSemiApply2LeftSemiJoin {
 private:
 public:
  CXformLeftSemiApplyIn2LeftSemiJoin(const CXformLeftSemiApplyIn2LeftSemiJoin &) = delete;
  ...
  // ident accessors
  EXformId Exfid() const override { return ExfLeftSemiApplyIn2LeftSemiJoin; }

  const CHAR *SzId() const override { return "CXformLeftSemiApplyIn2LeftSemiJoin"; }
