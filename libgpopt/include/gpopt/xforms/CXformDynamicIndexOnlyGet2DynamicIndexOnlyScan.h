...
//
//---------------------------------------------------------------------------
class CXformDynamicIndexOnlyGet2DynamicIndexOnlyScan : public CXformImplementation {
 private:
 public:
  CXformDynamicIndexOnlyGet2DynamicIndexOnlyScan(const CXformDynamicIndexOnlyGet2DynamicIndexOnlyScan &) = delete;
  ...
  // ident accessors
  EXformId Exfid() const override { return ExfDynamicIndexOnlyGet2DynamicIndexOnlyScan; }

  // return a string for xform name
  const CHAR *SzId() const override { return "CXformDynamicIndexOnlyGet2DynamicIndexOnlyScan"; }
