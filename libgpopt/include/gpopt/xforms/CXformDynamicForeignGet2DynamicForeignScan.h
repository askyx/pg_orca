...
class CXformDynamicForeignGet2DynamicForeignScan : public CXformImplementation {
 private:
 public:
  CXformDynamicForeignGet2DynamicForeignScan(const CXformDynamicForeignGet2DynamicForeignScan &) = delete;
  ...
  // ident accessors
  EXformId Exfid() const override { return ExfDynamicForeignGet2DynamicForeignScan; }

  // return a string for xform name
  const CHAR *SzId() const override { return "CXformDynamicForeignGet2DynamicForeignScan"; }
