...
class CCostContext : public CRefCount {
 ...
 public:
  ...
  COptimizationContextArray *Pdrgpoc() const { return m_pdrgpoc; }
  ...
  CGroupExpression *PgexprForStats() const { return m_pgexprForStats; }
  ...
  // set child contexts
  void SetChildContexts(COptimizationContextArray *pdrgpoc) {
  ...
  static BOOL Equals(const CCostContext &ccLeft, const CCostContext &ccRight) {
    ...
    return ccLeft.UlOptReq() == ccRight.UlOptReq() && ccLeft.Pgexpr() == ccRight.Pgexpr() &&
