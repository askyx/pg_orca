...
using UlongToDrvdPropPlanMap = CHashMap<ULONG, CDrvdPropPlan, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
                                        CleanupDelete<ULONG>, CleanupRelease<CDrvdPropPlan>>;

// iterator for plan properties map
using UlongToDrvdPropPlanMapIter = CHashMapIter<ULONG, CDrvdPropPlan, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
                                                CleanupDelete<ULONG>, CleanupRelease<CDrvdPropPlan>>;
 ...
 private:
  ...
  class CCTEMapEntry : public CRefCount {
   ...
   public:
    ...
    // ctor
    CCTEMapEntry(ULONG id, CCTEMap::ECteType ect, CDrvdPropPlan *pdpplan) : m_id(id), m_ect(ect), m_pdpplan(pdpplan) {
  ...
  using UlongToCTEMapEntryMap = CHashMap<ULONG, CCTEMapEntry, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
                                         CleanupDelete<ULONG>, CleanupRelease<CCTEMapEntry>>;

  // map iterator
  using UlongToCTEMapEntryMapIter = CHashMapIter<ULONG, CCTEMapEntry, gpos::HashValue<ULONG>, gpos::Equals<ULONG>,
                                                 CleanupDelete<ULONG>, CleanupRelease<CCTEMapEntry>>;
