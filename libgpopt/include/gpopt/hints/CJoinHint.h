...
class CJoinHint : public IHint {
 public:
  ...
  class JoinNode : public CRefCount {
   ...
   public:
    ...
    CWStringConst *GetName() const { return m_name; }

    JoinNode *GetOuter() const { return m_outer; }

    JoinNode *GetInner() const { return m_inner; }
 ...
 public:
  ...
  ~CJoinHint() override { m_join_node->Release(); }
