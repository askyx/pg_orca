...
class CLogicalForeignGet : public CLogicalGet {
 ...
 public:
  ...
  CLogicalForeignGet(CMemoryPool *mp, const CName *pnameAlias, CTableDescriptor *ptabdesc);

  CLogicalForeignGet(CMemoryPool *mp, const CName *pnameAlias, CTableDescriptor *ptabdesc, CColRefArray *pdrgpcrOutput);
  ...
  // conversion function
  static CLogicalForeignGet *PopConvert(COperator *pop) {
