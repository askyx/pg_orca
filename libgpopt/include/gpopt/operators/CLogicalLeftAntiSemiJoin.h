...
class CLogicalLeftAntiSemiJoin : public CLogicalJoin {
 ...
 public:
  ...
  // ctor
  explicit CLogicalLeftAntiSemiJoin(CMemoryPool *mp, CXform::EXformId origin_xform = CXform::ExfSentinel);
  ...
  // conversion function
  static CLogicalLeftAntiSemiJoin *PopConvert(COperator *pop) {
