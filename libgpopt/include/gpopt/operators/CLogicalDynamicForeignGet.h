...
class CLogicalDynamicForeignGet : public CLogicalDynamicGetBase {
 ...
 public:
  ...
  CLogicalDynamicForeignGet(CMemoryPool *mp, const CName *pnameAlias, CTableDescriptor *ptabdesc, ULONG ulPartIndex,
  ...
  EOperatorId Eopid() const override { return EopLogicalDynamicForeignGet; }

  // return a string for operator name
  const CHAR *SzId() const override { return "CLogicalDynamicForeignGet"; }
  ...
  // conversion function
  static CLogicalDynamicForeignGet *PopConvert(COperator *pop) {
