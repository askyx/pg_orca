...
class CLogicalLeftAntiSemiApply : public CLogicalApply {
 ...
 public:
  ...
  // ctor
  CLogicalLeftAntiSemiApply(CMemoryPool *mp, CColRefArray *pdrgpcrInner, EOperatorId eopidOriginSubq)
  ...
  // ident accessors
  EOperatorId Eopid() const override { return EopLogicalLeftAntiSemiApply; }

  // return a string for operator name
  const char *SzId() const override { return "CLogicalLeftAntiSemiApply"; }
