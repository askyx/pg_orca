...
class CPhysicalDynamicIndexOnlyScan : public CPhysicalDynamicIndexScan {
 public:
  CPhysicalDynamicIndexOnlyScan(const CPhysicalDynamicIndexOnlyScan &) = delete;

  // ctors
  CPhysicalDynamicIndexOnlyScan(CMemoryPool *mp, CIndexDescriptor *pindexdesc, CTableDescriptor *ptabdesc,
      ...
      : CPhysicalDynamicIndexScan(
            mp, pindexdesc, ptabdesc, ulOriginOpId, pnameAlias, pdrgpcrOutput, scan_id, pdrgpdrgpcrPart, pos,
  ...
  // ident accessors
  EOperatorId Eopid() const override { return EopPhysicalDynamicIndexOnlyScan; }

  // operator name
  const CHAR *SzId() const override { return "CPhysicalDynamicIndexOnlyScan"; }
  ...
  // conversion function
  static CPhysicalDynamicIndexOnlyScan *PopConvert(COperator *pop) {
