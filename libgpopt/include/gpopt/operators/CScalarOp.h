...
class CScalarOp : public CScalar {
 ...
 public:
  // ctor
  CScalarOp(CMemoryPool *mp, IMDId *mdid_op, IMDId *return_type_mdid, const CWStringConst *pstrOp);
  ...
  // ident accessors
  EOperatorId Eopid() const override { return EopScalarOp; }

  // return a string for operator name
  const char *SzId() const override { return "CScalarOp"; }
  ...
  // conversion function
  static CScalarOp *PopConvert(COperator *pop) {
