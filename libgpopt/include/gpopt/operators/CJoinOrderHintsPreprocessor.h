...
class CJoinOrderHintsPreprocessor {
 private:
  ...
  // binaryJoinExpr.
  static CExpressionArray *ConstructNAryJoinChildren(CMemoryPool *mp, CExpression *naryJoinPexpr,
  ...
  static CExpression *RecursiveApplyJoinOrderHintsOnNAryJoin(CMemoryPool *mp, CExpression *pexpr,
 ...
 public:
  ...
  static CExpression *PexprPreprocess(CMemoryPool *mp, CExpression *pexpr, const CJoinHint::JoinNode *joinnode);
};
