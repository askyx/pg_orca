...
class CScalar : public COperator {
 ...
 private:
  ...
  static CPartInfo *PpartinfoDeriveCombineScalar(CMemoryPool *mp, CExpressionHandle &exprhdl);
 ...
 public:
  ...
  virtual CColRefSet *PcrsDefined(CMemoryPool *mp,
  ...
  virtual CColRefSet *PcrsSetReturningFunction(CMemoryPool *mp,
                                               CExpressionHandle &  // exprhdl
  ) {
    // return an empty set of column refs
    return GPOS_NEW(mp) CColRefSet(mp);
  ...
  virtual CColRefSet *PcrsUsed(CMemoryPool *mp,
                               CExpressionHandle &  // exprhdl
  ) {
    // return an empty set of column refs
    return GPOS_NEW(mp) CColRefSet(mp);
  ...
  virtual CPartInfo *PpartinfoDerive(CMemoryPool *mp, CExpressionHandle &exprhdl) const {
  ...
  static EBoolEvalResult EberEvaluate(CMemoryPool *mp, CExpression *pexprScalar);

  // conversion function
  static CScalar *PopConvert(COperator *pop) {
