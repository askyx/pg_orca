...
class CPhysicalMotionHashDistribute : public CPhysicalMotion {
 ...
 public:
  CPhysicalMotionHashDistribute(const CPhysicalMotionHashDistribute &) = delete;

  // ctor
  CPhysicalMotionHashDistribute(CMemoryPool *mp, CDistributionSpecHashed *pdsHashed);

  // dtor
  ~CPhysicalMotionHashDistribute() override;

  // ident accessors
  EOperatorId Eopid() const override { return EopPhysicalMotionHashDistribute; }

  const CHAR *SzId() const override { return "CPhysicalMotionHashDistribute"; }

  // output distribution accessor
  CDistributionSpec *Pds() const override { return m_pdsHashed; }

  // is motion eliminating duplicates
  BOOL IsDuplicateSensitive() const { return m_pdsHashed->IsDuplicateSensitive(); }
