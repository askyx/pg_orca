...
class CLogicalDML : public CLogical {
 public:
  ...
  enum EDMLOperator { EdmlInsert, EdmlDelete, EdmlUpdate, EdmlSentinel };
 ...
 public:
  ...
  CBitSet *PbsModified() const { return m_pbsModified; }
  ...
  // conversion function
  static CLogicalDML *PopConvert(COperator *pop) {
