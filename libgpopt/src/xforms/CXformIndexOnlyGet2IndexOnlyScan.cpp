...
//
//---------------------------------------------------------------------------
CXformIndexOnlyGet2IndexOnlyScan::CXformIndexOnlyGet2IndexOnlyScan(CMemoryPool *mp)
    :  // pattern
...
CXform::EXformPromise CXformIndexOnlyGet2IndexOnlyScan::Exfp(CExpressionHandle &exprhdl) const {
  CLogicalIndexOnlyGet *popGet = CLogicalIndexOnlyGet::PopConvert(exprhdl.Pop());
...
//
//---------------------------------------------------------------------------
void CXformIndexOnlyGet2IndexOnlyScan::Transform(CXformContext *pxfctxt, CXformResult *pxfres,
  ...
  CExpression *pexprAlt =
      GPOS_NEW(mp) CExpression(mp,
                               GPOS_NEW(mp) CPhysicalIndexOnlyScan(mp, pindexdesc, ptabdesc, pexpr->Pop()->UlOpId(),
