...
//
//---------------------------------------------------------------------------
void CXformFullJoinCommutativity::Transform(CXformContext *pxfctxt, CXformResult *pxfres, CExpression *pexpr) const {
  ...
  CExpression *pexprAlt = CUtils::PexprLogicalJoin<CLogicalFullOuterJoin>(mp, pexprRight, pexprLeft, pexprScalar);
