...
//
//---------------------------------------------------------------------------
CXformSelect2DynamicIndexOnlyGet::CXformSelect2DynamicIndexOnlyGet(CMemoryPool *mp)
    :  // pattern
...
//
//---------------------------------------------------------------------------
CXform::EXformPromise CXformSelect2DynamicIndexOnlyGet::Exfp(CExpressionHandle &exprhdl) const {
...
//
//---------------------------------------------------------------------------
void CXformSelect2DynamicIndexOnlyGet::Transform(CXformContext *pxfctxt, CXformResult *pxfres,
  ...
  for (ULONG ul = 0; ul < ulIndices; ul++) {
    ...
    CExpression *pexprDynamicIndexGet = CXformUtils::PexprBuildBtreeIndexPlan(
        ...
        pmdindex, pmdrel, EForwardScan /*indexScanDirection*/, false /*indexForOrderBy*/, true /*indexonly*/);
