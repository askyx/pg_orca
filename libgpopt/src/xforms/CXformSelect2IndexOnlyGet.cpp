...
CXform::EXformPromise CXformSelect2IndexOnlyGet::Exfp(CExpressionHandle &exprhdl) const {
...
//
//---------------------------------------------------------------------------
void CXformSelect2IndexOnlyGet::Transform(CXformContext *pxfctxt, CXformResult *pxfres, CExpression *pexpr) const {
