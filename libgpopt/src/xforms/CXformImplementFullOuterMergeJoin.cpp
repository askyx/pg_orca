...
// ctor
CXformImplementFullOuterMergeJoin::CXformImplementFullOuterMergeJoin(CMemoryPool *mp)
    : CXformExploration(
          // pattern
...
CXform::EXformPromise CXformImplementFullOuterMergeJoin::Exfp(CExpressionHandle &exprhdl) const {
...
void CXformImplementFullOuterMergeJoin::Transform(CXformContext *pxfctxt, CXformResult *pxfres,
