...
//
//---------------------------------------------------------------------------
void COptimizerConfig::Serialize(CMemoryPool *mp, CXMLSerializer *xml_serializer, CBitSet *pbsTrace) const {
  ...
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenDampingFactorFilter),
                               m_stats_conf->DDampingFactorFilter());
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenDampingFactorJoin),
                               m_stats_conf->DDampingFactorJoin());
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenDampingFactorGroupBy),
  ...
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenCTEInliningCutoff),
  ...
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenJoinArityForAssociativityCommutativity),
                               m_hint->UlJoinArityForAssociativityCommutativity());
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenArrayExpansionThreshold),
  ...
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenEnforceConstraintsOnDML),
                               m_hint->FEnforceConstraintsOnDML());
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenPushGroupByBelowSetopThreshold),
                               m_hint->UlPushGroupByBelowSetopThreshold());
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenXformBindThreshold), m_hint->UlXformBindThreshold());
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(gpdxl::EdxltokenSkewFactor), m_hint->UlSkewFactor());
  xml_serializer->CloseElement(CDXLTokens::GetDXLTokenStr(EdxltokenNamespacePrefix),
                               CDXLTokens::GetDXLTokenStr(EdxltokenHint));
