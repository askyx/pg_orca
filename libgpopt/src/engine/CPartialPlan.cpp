...
//
//---------------------------------------------------------------------------
void CPartialPlan::ExtractChildrenCostingInfo(CMemoryPool *mp, ICostModel *pcm, CExpressionHandle &exprhdl,
  ...
  for (ULONG ul = 0; ul < arity; ul++) {
    ...
    if (nullptr == child_stats) {
      GPOS_RAISE(gpopt::ExmaGPOPT, gpopt::ExmiNoStats, GPOS_WSZ_LIT("CPartialPlan"));
    }
...
//
//---------------------------------------------------------------------------
CCost CPartialPlan::CostCompute(CMemoryPool *mp) {
