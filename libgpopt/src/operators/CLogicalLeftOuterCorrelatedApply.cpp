...
CLogicalLeftOuterCorrelatedApply::CLogicalLeftOuterCorrelatedApply(CMemoryPool *mp, CColRefArray *pdrgpcrInner,
    ...
    : CLogicalLeftOuterApply(mp, pdrgpcrInner, eopidOriginSubq),
      ...
      // subplan ALL_SUBLINK.
      m_allow_predicate_pushdown(COperator::EopScalarSubqueryAll != eopidOriginSubq) {}
...
//
//---------------------------------------------------------------------------
CXformSet *CLogicalLeftOuterCorrelatedApply::PxfsCandidates(CMemoryPool *mp) const {
