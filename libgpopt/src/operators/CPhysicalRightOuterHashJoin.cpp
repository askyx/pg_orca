...
CDistributionSpec *CPhysicalRightOuterHashJoin::PdsDerive(CMemoryPool *mp, CExpressionHandle &exprhdl) const {
...
//
//---------------------------------------------------------------------------
CEnfdDistribution *CPhysicalRightOuterHashJoin::Ped(CMemoryPool *mp, CExpressionHandle &exprhdl,
                                                    CReqdPropPlan *prppInput, ULONG child_index,
                                                    CDrvdPropArray *pdrgpdpCtxt, ULONG ulOptReq) {
  return PedRightOrFullJoin(mp, exprhdl, prppInput, child_index, pdrgpdpCtxt, ulOptReq);
}

void CPhysicalRightOuterHashJoin::CreateOptRequests(CMemoryPool *mp) {
