...
//
//---------------------------------------------------------------------------
IMDId *CScalarArray::PmdidElem() const {
  return m_pmdidElem;
}
...
//
//---------------------------------------------------------------------------
IMDId *CScalarArray::PmdidArray() const {
  return m_pmdidArray;
}
...
//
//---------------------------------------------------------------------------
IMDId *CScalarArray::MdidType() const {
  return m_pmdidArray;
}

CScalarConstArray *CScalarArray::PdrgPconst() const {
  return m_pdrgPconst;
}

IOstream &CScalarArray::OsPrint(IOstream &os) const {
