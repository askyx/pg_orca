...
CScalar::EBoolEvalResult CScalarIsDistinctFrom::Eber(ULongPtrArray *pdrgpulChildren) const {
  ...
  if (firstResult == EberAny || secondResult == EberAny || firstResult == EberNotTrue || secondResult == EberNotTrue) {
...
CScalarCmp *CScalarIsDistinctFrom::PopCommutedOp(CMemoryPool *mp) {
