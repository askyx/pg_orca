...
//
//---------------------------------------------------------------------------
CLogicalForeignGet::CLogicalForeignGet(CMemoryPool *mp, const CName *pnameAlias, CTableDescriptor *ptabdesc)
...
COperator *CLogicalForeignGet::PopCopyWithRemappedColumns(CMemoryPool *mp, UlongToColRefMap *colref_mapping,
  ...
  return GPOS_NEW(mp) CLogicalForeignGet(mp, pnameAlias, ptabdesc, pdrgpcrOutput);
}
...
//
//---------------------------------------------------------------------------
CXformSet *CLogicalForeignGet::PxfsCandidates(CMemoryPool *mp) const {
