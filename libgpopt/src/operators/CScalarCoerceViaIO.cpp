...
//
//---------------------------------------------------------------------------
CScalarCoerceViaIO::CScalarCoerceViaIO(CMemoryPool *mp, IMDId *mdid_type, int32_t type_modifier, ECoercionForm ecf,
                                       int32_t location)
...
//
//---------------------------------------------------------------------------
bool CScalarCoerceViaIO::Matches(COperator *pop) const {
  if (pop->Eopid() == Eopid()) {
