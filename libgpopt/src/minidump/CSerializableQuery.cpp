...
//
//---------------------------------------------------------------------------
CSerializableQuery::CSerializableQuery(CMemoryPool *mp, const CDXLNode *query,
...
//
//---------------------------------------------------------------------------
void CSerializableQuery::Serialize(COstream &oos) {
  CDXLUtils::SerializeQuery(
      m_mp, oos, m_query_dxl_root, m_query_output, m_cte_producers, false /*fSerializeHeaders*/, false /*indentation*/
  );
}
