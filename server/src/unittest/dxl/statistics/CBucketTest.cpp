...
CBucketTest::EresUnittest() {
  ...
  CUnittest rgutSharedOptCtxt[] = {
      ...
      GPOS_UNITTEST_FUNC(CBucketTest::EresUnittest_CBucketMergeCommutativityDoubleDatum),
      GPOS_UNITTEST_FUNC(CBucketTest::EresUnittest_CBucketMergeCommutativityDoubleDatumSameLowerBounds),
      GPOS_UNITTEST_FUNC(CBucketTest::EresUnittest_CBucketMergeCommutativityDoubleDatumSameUpperBounds),
  };
...
CBucketTest::EresUnittest_CBucketInt4() {
  ...
  GPOS_UNITTEST_ASSERT_MSG(CDouble(1.0) == bucket1->GetOverlapPercentage(point1, true /*include_point*/),
                           "overlap of 1 in [1,1] must 1.0");

  GPOS_UNITTEST_ASSERT_MSG(!bucket1->Contains(point2), "[1,1] must not contain 2");
  ...
  // bucket [1,10)
  CBucket *bucket3 =
      GPOS_NEW(mp) CBucket(CTestUtils::PpointInt4(mp, 1), CTestUtils::PpointInt4(mp, 10), true /* is_lower_closed */,
                           true /* is_upper_closed */, CDouble(1.0), CDouble(10.0));
  CCardinalityTestUtils::PrintBucket(mp, "b3", bucket3);
  // bucket (1, 5)
  CBucket *bucket4 =
      GPOS_NEW(mp) CBucket(CTestUtils::PpointInt4(mp, 1), CTestUtils::PpointInt4(mp, 5), false /* is_lower_closed */,
                           false /* is_upper_closed */, CDouble(1.0), CDouble(5.0));
  CCardinalityTestUtils::PrintBucket(mp, "b4", bucket4);
  // bucket [1, 5)
  CBucket *bucket5 =
      GPOS_NEW(mp) CBucket(CTestUtils::PpointInt4(mp, 1), CTestUtils::PpointInt4(mp, 5), true /* is_lower_closed */,
                           false /* is_upper_closed */, CDouble(1.0), CDouble(5.0));
  ...
  // point IsBefore
  GPOS_UNITTEST_ASSERT_MSG(pbucket4->IsBefore(point2), "2 must be before (2,4)");

  // bucket IsBefore
  GPOS_UNITTEST_ASSERT_MSG(pbucket3->IsBefore(pbucket4), "[1,2] must be before (2,4)");
...
CBucketTest::EresUnittest_CBucketBool() {
  ...
  GPOS_UNITTEST_ASSERT_MSG(bucket->Contains(p1), "true bucket must contain true");
  GPOS_UNITTEST_ASSERT_MSG(CDouble(1.0) == bucket->GetOverlapPercentage(p1), "overlap must 1.0");

  GPOS_UNITTEST_ASSERT_MSG(!bucket->Contains(p2), "true bucket must not contain false");
  GPOS_UNITTEST_ASSERT_MSG(CDouble(0.0) == bucket->GetOverlapPercentage(p2), "overlap must 0.0");
...
CBucketTest::EresUnittest_CBucketIntersect() {
  ...
  SBucketsIntersectTestElem rgBucketsIntersectTestElem[] = {
      {7, 203, true, true, CDouble(0.1), CDouble(100), 3, 213, true, true, CDouble(0.1), CDouble(100), true, 7, 203,
       true, true, CDouble(9.33e-05), CDouble(93.33)},  // overlaps
      {3, 213, true, true, CDouble(0.1), CDouble(100), 7, 203, true, true, CDouble(0.1), CDouble(100), true, 7, 203,
       true, true, CDouble(9.33e-05), CDouble(93.33)},  // same as above but reversed
      {13, 103, true, true, CDouble(0.1), CDouble(100), 2, 98, true, true, CDouble(0.1), CDouble(100), true, 13, 98,
       true, true, CDouble(8.85e-05), CDouble(88.54)},  // subsumes
      {2, 99, true, true, CDouble(0.1), CDouble(100.0), 13, 103, true, true, CDouble(0.1), CDouble(100), true, 13, 99,
       true, true, CDouble(8.87e-05), CDouble(88.66)},  // same as above but reversed
      {0, 5, true, true, CDouble(0.1), CDouble(100), 10, 15, false, true, CDouble(0.1), CDouble(100), false, -1, -1,
       false, false, CDouble(0.1), CDouble(100)},  // negative
      {10, 15, true, true, CDouble(0.1), CDouble(100), 0, 5, false, true, CDouble(0.1), CDouble(100), false, -1, -1,
       false, false, CDouble(0.1), CDouble(100)},  // same as above but reversed
      {0, 5, true, true, CDouble(0.1), CDouble(100), 5, 10, true, true, CDouble(0.1), CDouble(100), true, 5, 5, true,
       true, CDouble(2.00e-05),
       CDouble(20)},  // ub of one bucket is the same as lb of the other and both bounds are closed
      {5, 10, true, true, CDouble(0.1), CDouble(100), 0, 5, true, true, CDouble(0.1), CDouble(100), true, 5, 5, true,
       true, CDouble(2.00e-05), CDouble(20)},  // same as above but reversed
      {0, 5, true, true, CDouble(0.1), CDouble(100), 5, 10, false, true, CDouble(0.1), CDouble(100), false, -1, -1,
       false, false, CDouble(0.1),
       CDouble(100)},  // ub of one bucket is the same as lb of the other but closing criteria are different
      {5, 10, false, true, CDouble(0.1), CDouble(100), 0, 5, true, true, CDouble(0.1), CDouble(100), false, -1, -1,
       false, false, CDouble(0.1), CDouble(100)},  // same as above but reversed
      {0, 5, true, true, CDouble(0.1), CDouble(100), 0, 5, false, true, CDouble(0.1), CDouble(100), true, 0, 5, false,
       true, CDouble(0.00010000000000000002), CDouble(100)},  // exact match but only differ in closure of lb
      {0, 5, true, true, CDouble(0.1), CDouble(100), 0, 5, true, true, CDouble(0.1), CDouble(100), true, 0, 5, true,
       true, CDouble(0.00010000000000000002), CDouble(100)},  // exact match with all bounds closed
      {0, 5, true, false, CDouble(0.1), CDouble(100), 0, 5, true, false, CDouble(0.1), CDouble(100), true, 0, 5, true,
       false, CDouble(0.00010000000000000002), CDouble(100)},  // exact match with ubs open
      {0, 5, false, false, CDouble(0.1), CDouble(100), 0, 5, true, false, CDouble(0.1), CDouble(100), true, 0, 5, false,
       false, CDouble(0.00010000000000000002), CDouble(100)},  // exact match with lbs differ in closure
      {
          0,
          5,
          true,
      ...
      {
          0,          5,          true, true, CDouble(0), CDouble(0), 0,     5,          true,       false,
          CDouble(0), CDouble(0), true, 0,    5,          true,       false, CDouble(0), CDouble(0),
      },  // overlaps but both buckets are empty
      {
          0,          5,    true, true, CDouble(0.1), CDouble(100), 0,          5,          true, false, CDouble(0),
          CDouble(0), true, 0,    5,    true,         false,        CDouble(0), CDouble(0),
      },
  ...
  for (ULONG ul = 0; ul < length; ul++) {
    CBucket *bucket1 = CCardinalityTestUtils::PbucketInteger(
        mp, rgBucketsIntersectTestElem[ul].m_iLb1, rgBucketsIntersectTestElem[ul].m_iUb1,
        rgBucketsIntersectTestElem[ul].m_fLb1Closed, rgBucketsIntersectTestElem[ul].m_fUb1Closed,
        rgBucketsIntersectTestElem[ul].m_frequency1, rgBucketsIntersectTestElem[ul].m_distinct1);

    CBucket *bucket2 = CCardinalityTestUtils::PbucketInteger(
        mp, rgBucketsIntersectTestElem[ul].m_iLb2, rgBucketsIntersectTestElem[ul].m_iUb2,
        rgBucketsIntersectTestElem[ul].m_fLb2Closed, rgBucketsIntersectTestElem[ul].m_fUb2Closed,
        rgBucketsIntersectTestElem[ul].m_frequency2, rgBucketsIntersectTestElem[ul].m_distinct2);
    ...
    if (true == result) {
      ...
      CBucket *pbucketExpected = CCardinalityTestUtils::PbucketInteger(
          mp, rgBucketsIntersectTestElem[ul].m_iLbOutput, rgBucketsIntersectTestElem[ul].m_iUbOutput,
          rgBucketsIntersectTestElem[ul].m_fLbOutputClosed, rgBucketsIntersectTestElem[ul].m_fUbOutputClosed,
          rgBucketsIntersectTestElem[ul].m_frequencyOutput, rgBucketsIntersectTestElem[ul].m_distinctOutput);
...
BOOL CBucketTest::FMatchBucket(CBucket *bucket1, CBucket *bucket2) {
  ...
  if (fabs((bucket1->GetFrequency() - bucket2->GetFrequency()).Get()) > CStatistics::Epsilon) {
    return false;
  }
...
CBucketTest::EresUnittest_CBucketMergeCommutativityUnion() {
  ...
  CBucket *result1 = bucket1->SplitAndMergeBuckets(mp, bucket2, 1000, 600, &bucket1_new1, &bucket2_new1, &result_rows1,
                                                   false /*is_union_all*/);

  CBucket *bucket1_new2 = nullptr;
  CBucket *bucket2_new2 = nullptr;
  CDouble result_rows2(0.0);
  CBucket *result2 = bucket2->SplitAndMergeBuckets(mp, bucket1, 600, 1000, &bucket1_new2, &bucket2_new2, &result_rows2,
                                                   false /*is_union_all*/);
...
CBucketTest::EresUnittest_CBucketMergeCommutativitySameLowerBounds() {
  ...
  CBucket *bucket2 = GPOS_NEW(mp)
      CBucket(ppLower, ppUpper, false /* is_lower_closed */, false /*is_upper_closed*/, CDouble(0.2), CDouble(50));
...
CBucketTest::EresUnittest_CBucketMergeCommutativitySameUpperBounds() {
  ...
  CBucket *bucket2 = GPOS_NEW(mp)
      CBucket(ppLower, ppUpper, true /* is_lower_closed */, true /*is_upper_closed*/, CDouble(0.2), CDouble(50));
...
CBucketTest::EresUnittest_CBucketMergeCommutativityDoubleDatum() {
  ...
  // [0.0, 100.0)
  CPoint *ppLower1 = CCardinalityTestUtils::PpointDouble(mp, GPDB_FLOAT8, CDouble(0.0));
  CPoint *ppUpper1 = CCardinalityTestUtils::PpointDouble(mp, GPDB_FLOAT8, CDouble(100.0));

  CBucket *bucket1 = GPOS_NEW(mp)
      CBucket(ppLower1, ppUpper1, true /* is_lower_closed */, false /*is_upper_closed*/, CDouble(0.2), CDouble(50));

  // [50.0, 150.0)
  CPoint *ppLower2 = CCardinalityTestUtils::PpointDouble(mp, GPDB_FLOAT8, CDouble(50.0));
  CPoint *ppUpper2 = CCardinalityTestUtils::PpointDouble(mp, GPDB_FLOAT8, CDouble(150.0));
  CBucket *bucket2 = GPOS_NEW(mp)
      CBucket(ppLower2, ppUpper2, true /* is_lower_closed */, false /*is_upper_closed*/, CDouble(0.2), CDouble(50));
...
CBucketTest::EresUnittest_CBucketMergeCommutativityDoubleDatumSameLowerBounds() {
  ...
  // b2 = (0,50)
  CPoint *ppLower2 = CCardinalityTestUtils::PpointDouble(mp, GPDB_FLOAT8, CDouble(0.0));
  CPoint *ppUpper2 = CCardinalityTestUtils::PpointDouble(mp, GPDB_FLOAT8, CDouble(50.0));
  CBucket *bucket2 = GPOS_NEW(mp)
      CBucket(ppLower2, ppUpper2, false /* is_lower_closed */, false /*is_upper_closed*/, CDouble(0.2), CDouble(50));
...
CBucketTest::EresUnittest_CBucketMergeCommutativityDoubleDatumSameUpperBounds() {
  ...
  CBucket *bucket1 = GPOS_NEW(mp)
      CBucket(ppLower1, ppUpper1, true /* is_lower_closed */, false /*is_upper_closed*/, CDouble(0.4), CDouble(50));

  // b2 = [0,100]
  CPoint *ppLower2 = CCardinalityTestUtils::PpointDouble(mp, GPDB_FLOAT8, CDouble(0.0));
  CPoint *ppUpper2 = CCardinalityTestUtils::PpointDouble(mp, GPDB_FLOAT8, CDouble(100.0));
  CBucket *bucket2 = GPOS_NEW(mp)
      CBucket(ppLower2, ppUpper2, true /* is_lower_closed */, true /*is_upper_closed*/, CDouble(0.2), CDouble(50));
