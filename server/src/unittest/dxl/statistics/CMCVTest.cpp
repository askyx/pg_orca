...
CMCVTest::EresUnittest_SortInt4MCVs() {
  ...
  CHistogram *phistMCV =
      CStatisticsUtils::TransformMCVToHist(mp, pmdtype, pdrgpdatumMCV, pdrgpdFreq, pdrgpdatumMCV->Size());
...
CMCVTest::EresUnittest_MergeHistMCV() {
  SMergeTestElem rgMergeTestElem[] = {
      {"../data/dxl/statistics/Merge-Input-MCV-Int.xml", "../data/dxl/statistics/Merge-Input-Histogram-Int.xml",
       "../data/dxl/statistics/Merge-Output-Int.xml"},

      {"../data/dxl/statistics/Merge-Input-MCV-Numeric.xml", "../data/dxl/statistics/Merge-Input-Histogram-Numeric.xml",
  ...
  for (ULONG ul = 0; ul < length; ul++) {
    ...
    CDXLStatsDerivedRelationArray *pdrgpdxlstatsderrelMCV =
        CDXLUtils::ParseDXLToStatsDerivedRelArray(mp, szDXLInputMCV, nullptr);
    CDXLStatsDerivedRelationArray *pdrgpdxlstatsderrelHist =
        CDXLUtils::ParseDXLToStatsDerivedRelArray(mp, szDXLInputHist, nullptr);
    ...
    CStatistics *stats = GPOS_NEW(mp) CStatistics(mp, col_histogram_mapping, colid_width_mapping,
