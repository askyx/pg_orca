...
//
//---------------------------------------------------------------------------
gpdxl::CDXLNode *CConstExprEvaluatorDXLTest::CDummyConstDXLNodeEvaluator::EvaluateExpr(
...
CConstExprEvaluatorDXLTest::EresUnittest() {
  {
    CUnittest rgut[] = {
        ...
        GPOS_UNITTEST_FUNC_THROW(CConstExprEvaluatorDXLTest::EresUnittest_NestedSubquery, gpdxl::ExmaGPOPT,
                                 gpdxl::ExmiEvalUnsupportedScalarExpr),
        GPOS_UNITTEST_FUNC_THROW(CConstExprEvaluatorDXLTest::EresUnittest_ScalarContainingVariables, gpdxl::ExmaGPOPT,
                                 gpdxl::ExmiEvalUnsupportedScalarExpr),
    };
...
CConstExprEvaluatorDXLTest::EresUnittest_NonScalar() {
  ...
  CDummyConstDXLNodeEvaluator const_eval(mp, testsetup.Pmda(), m_iDefaultEvalValue);
  CConstExprEvaluatorDXL *pceeval = GPOS_NEW(mp) CConstExprEvaluatorDXL(mp, testsetup.Pmda(), &const_eval);
...
CConstExprEvaluatorDXLTest::EresUnittest_NestedSubquery() {
  ...
  GPOS_UNITTEST_ASSERT(COperator::EopScalarSubqueryAny == pexprPredicate->Pop()->Eopid());
