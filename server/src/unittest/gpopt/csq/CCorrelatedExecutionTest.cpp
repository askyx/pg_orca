...
const CHAR *rgszPositiveTests[] = {
    "../data/dxl/csq_tests/dxl-q1.xml",  "../data/dxl/csq_tests/dxl-q2.xml",  "../data/dxl/csq_tests/dxl-q3.xml",
    "../data/dxl/csq_tests/dxl-q4.xml",  "../data/dxl/csq_tests/dxl-q5.xml",  "../data/dxl/csq_tests/dxl-q6.xml",
    "../data/dxl/csq_tests/dxl-q7.xml",  "../data/dxl/csq_tests/dxl-q8.xml",  "../data/dxl/csq_tests/dxl-q9.xml",
    "../data/dxl/csq_tests/dxl-q10.xml", "../data/dxl/csq_tests/dxl-q11.xml", "../data/dxl/csq_tests/dxl-q12.xml",
    "../data/dxl/csq_tests/dxl-q13.xml", "../data/dxl/csq_tests/dxl-q14.xml", "../data/dxl/csq_tests/dxl-q15.xml",
...
CCorrelatedExecutionTest::EresUnittest_RunAllPositiveTests() {
  ...
  for (ULONG ul = m_ulTestCounter; ul < GPOS_ARRAY_SIZE(rgszPositiveTests); ul++) {
    ...
    GPOS_RESULT eres =
        CTestUtils::EresTranslate(mp, rgszPositiveTests[ul], nullptr /* plan file */, true /*fIgnoreMismatch*/
        );
