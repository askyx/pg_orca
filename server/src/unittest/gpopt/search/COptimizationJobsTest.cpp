...
COptimizationJobsTest::EresUnittest_StateMachine() {
  ...
  // install opt context in TLS
  {
...
#ifdef GPOS_DEBUG
    {
      ...
      GPOS_UNITTEST_ASSERT(size == 1 && pestate[0] == CJobGroupOptimization::estInitialized);
...

    {
      ...
      GPOS_UNITTEST_ASSERT(size == 1 && pestate[0] == CJobGroupImplementation::estInitialized);
...

    {
      ...
      GPOS_UNITTEST_ASSERT(size == 1 && pestate[0] == CJobGroupExploration::estInitialized);
...

    {
      ...
      GPOS_UNITTEST_ASSERT(size == 1 && pestate[0] == CJobGroupExpressionOptimization::estInitialized);
...

    {
      ...
      GPOS_UNITTEST_ASSERT(size == 1 && pestate[0] == CJobGroupExpressionImplementation::estInitialized);
...

    {
      ...
      GPOS_UNITTEST_ASSERT(size == 1 && pestate[0] == CJobGroupExpressionExploration::estInitialized);
...

    {
      ...
      while (xsi.Advance()) {
        ...
        GPOS_UNITTEST_ASSERT(size == 1 && pestate[0] == CJobTransformation::estInitialized);
