...
CTreeMapTest::EresUnittest() {
  CUnittest rgut[] = {
      GPOS_UNITTEST_FUNC(CTreeMapTest::EresUnittest_Basic),        GPOS_UNITTEST_FUNC(CTreeMapTest::EresUnittest_Count),
      GPOS_UNITTEST_FUNC(CTreeMapTest::EresUnittest_Unrank),       GPOS_UNITTEST_FUNC(CTreeMapTest::EresUnittest_Memo),
...
//
//---------------------------------------------------------------------------
IOstream &CTreeMapTest::CNode::OsPrintWithIndent(IOstream &os, ULONG ulIndent) const {
...
//
//---------------------------------------------------------------------------
CTreeMapTest::CNode *CTreeMapTest::Pnd(CMemoryPool *mp, ULONG *pul, CNodeArray *pdrgpnd, BOOL *fTestTrue) {
...
//
//---------------------------------------------------------------------------
CTreeMapTest::TestMap *CTreeMapTest::PtmapLoad(CMemoryPool *mp) {
...
CTreeMapTest::EresUnittest_Count() {
  ...
  for (ULONG ul = 0; ul < ulElems; ul++) {
    oss << "node: " << ul << " count: " << ptmap->UllCount(&rgul[ul]) << std::endl;
  }
