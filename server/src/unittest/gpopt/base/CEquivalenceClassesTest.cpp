...
CEquivalenceClassesTest::EresUnittest() {
  CUnittest rgut[] = {GPOS_UNITTEST_FUNC(CEquivalenceClassesTest::EresUnittest_NotDisjointEquivalanceClasses),
...
CEquivalenceClassesTest::EresUnittest_IntersectEquivalanceClasses() {
  ...
  GPOS_UNITTEST_ASSERT(CUtils::FEquivalanceClassesEqual(mp, pdrgpResult, pdrgpIntersectExpectedOp));
