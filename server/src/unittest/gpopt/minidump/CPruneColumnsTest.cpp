...
const CHAR *rgszPruneColumnsFileNames[] = {
    ...
    "../data/dxl/minidump/CPruneColumnsTest/MultiLevelSubqueryWithSetRetFuncs.mdp",  // expect error in optimizer and
                                                                                     // planner: "Expected no more than
                                                                                     // one row to be returned by
                                                                                     // expression"
    "../data/dxl/minidump/CPruneColumnsTest/MultiLevelSubqueryWithSetRetFuncsAndScalarFuncs.mdp",  // if pruning
                                                                                                   // subquery is
                                                                                                   // handled then we
                                                                                                   // should prune some
                                                                                                   // columns
...
GPOS_RESULT
CPruneColumnsTest::EresUnittest_RunTests() {
  return CTestUtils::EresUnittest_RunTests(rgszPruneColumnsFileNames, &m_ulPruneColumnsTestCounter,
