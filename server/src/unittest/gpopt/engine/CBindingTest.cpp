...
CBindingTest::EresUnittest_Basic() {
  ...
  CExpression *pexprTranslated = pdxltr->PexprTranslateQuery(pdxlmd->GetQueryDXLRoot(), pdxlmd->PdrgpdxlnQueryOutput(),
  ...
  ULONG bindings_for_xform = (ULONG)(*number_of_bindings)[search_stage][CXform::ExfJoin2IndexGetApply];
