...
//
//---------------------------------------------------------------------------
BOOL CEnumeratorTest::FHasNoMotions(CExpression *pexpr) {
  COperator::EOperatorId rgeopid[] = {COperator::EopPhysicalMotionGather, COperator::EopPhysicalMotionHashDistribute,
                                      COperator::EopPhysicalMotionBroadcast, COperator::EopPhysicalMotionRandom,
...
//
//---------------------------------------------------------------------------
BOOL CEnumeratorTest::FHasNoMotionBroadcast(CExpression *pexpr) {
...
//
//---------------------------------------------------------------------------
BOOL CEnumeratorTest::FHasNoMotionRedistribute(CExpression *pexpr) {
  COperator::EOperatorId rgeopid[] = {COperator::EopPhysicalMotionHashDistribute, COperator::EopPhysicalMotionRandom,
                                      COperator::EopPhysicalMotionRoutedDistribute};
...
//
//---------------------------------------------------------------------------
BOOL CEnumeratorTest::FHasNoMotionGather(CExpression *pexpr) {
  COperator::EOperatorId rgeopid[] = {
...
//
//---------------------------------------------------------------------------
BOOL CEnumeratorTest::FHasNoSort(CExpression *pexpr) {
  COperator::EOperatorId rgeopid[] = {
...
//
//---------------------------------------------------------------------------
BOOL CEnumeratorTest::FHasNoSpool(CExpression *pexpr) {
  COperator::EOperatorId rgeopid[] = {
...
//
//---------------------------------------------------------------------------
BOOL CEnumeratorTest::FHasNoPartPropagation(CExpression *pexpr) {
  COperator::EOperatorId rgeopid[] = {COperator::EopPhysicalPartitionSelector};
...
//
//---------------------------------------------------------------------------
BOOL CEnumeratorTest::FHasNoOneStageAgg(CExpression *pexpr) {
...
CEnumeratorTest::EresUnittest_Sampling() {
  ...
  GPOS_TRY {
    eres = CTestUtils::EresSamplePlans(rgszSamplePlans, GPOS_ARRAY_SIZE(rgszSamplePlans), &m_ulSamplingTestCounter,
                                       1,  // ulSessionId
                                       1   // ulCmdId
    );
  }
...
CEnumeratorTest::EresUnittest_RunUnsatisfiedRequiredPropertiesTests() {
  ...
  for (ULONG ul = 0; ul < ulTests; ++ul) {
    GPOS_TRY {
      (void)CTestUtils::EresSamplePlans(&rgszUnsatisfiedRequiredPropertiesPlans[ul],
                                        1,  // ulTests
...
CEnumeratorTest::EresUnittest_RunCompatibleDistributions() {
  ...
  return CTestUtils::EresRunMinidumps(mp, rgszCompatibleDistributions, ulTests, &m_ulCompatibleDistributionsTestCounter,
                                      1,     // ulSessionId
                                      1,     // ulCmdId
                                      true,  // fMatchPlans
...
//---------------------------------------------------------------------------
GPOS_RESULT
CEnumeratorTest::EresUnittest_CheckPlans(EOptTraceFlag eopttrace, FnPlanChecker *pfpc, ULONG *pulTestCounter,
                                         const CHAR *rgszCheckPlans[], ULONG ulTests) {
  ...
  GPOS_TRY {
    ...
    eres = CTestUtils::EresCheckPlans(rgszCheckPlans, ulTests, pulTestCounter,
                                      1,    // ulSessionId
                                      1,    // ulCmdId
...
GPOS_RESULT
CEnumeratorTest::EresUnittest_CheckNoMotions() {
  return EresUnittest_CheckPlans(EopttraceDisableMotions, FHasNoMotions, &m_ulSamplingTestNoMotions,
...
GPOS_RESULT
CEnumeratorTest::EresUnittest_CheckNoMotionBroadcast() {
  return EresUnittest_CheckPlans(EopttraceDisableMotionBroadcast, FHasNoMotionBroadcast,
...
CEnumeratorTest::EresUnittest_CheckNoMotionRedistribute() {
  ...
  return EresUnittest_CheckPlans(EopttraceDisableMotionHashDistribute, FHasNoMotionRedistribute,
                                 &m_ulSamplingTestNoMotionRedistribute, rgszCheckPlansNoMotionRedistribute,
...
GPOS_RESULT
CEnumeratorTest::EresUnittest_CheckNoMotionGather() {
  return EresUnittest_CheckPlans(EopttraceDisableMotionGather, FHasNoMotionGather, &m_ulSamplingTestNoMotionGather,
                                 rgszCheckPlansNoMotionGather, GPOS_ARRAY_SIZE(rgszCheckPlansNoMotionGather));
}
...
GPOS_RESULT
CEnumeratorTest::EresUnittest_CheckNoSort() {
  return EresUnittest_CheckPlans(EopttraceDisableSort, FHasNoSort, &m_ulSamplingTestNoSort, rgszCheckPlansNoSort,
...
GPOS_RESULT
CEnumeratorTest::EresUnittest_CheckNoSpool() {
  return EresUnittest_CheckPlans(EopttraceDisableSpool, FHasNoSpool, &m_ulSamplingTestNoSpool, rgszCheckPlansNoSpool,
...
CEnumeratorTest::EresUnittest_CheckNoPartPropagation() {
  GPOS_RESULT eres = GPOS_OK;
  GPOS_TRY {
    eres = EresUnittest_CheckPlans(EopttraceDisablePartPropagation, FHasNoPartPropagation,
...
GPOS_RESULT
CEnumeratorTest::EresUnittest_CheckNoOneStageAgg() {
  return EresUnittest_CheckPlans(EopttraceForceMultiStageAgg, FHasNoOneStageAgg, &m_ulSamplingTestNoOneStageAgg,
                                 rgszCheckPlansNoOneStageAgg, GPOS_ARRAY_SIZE(rgszCheckPlansNoOneStageAgg));
}
