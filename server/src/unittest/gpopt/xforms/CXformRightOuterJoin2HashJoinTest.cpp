...
CXformRightOuterJoin2HashJoinTest::EresUnittest() {
  CUnittest rgut[] = {
      GPOS_UNITTEST_FUNC(CXformRightOuterJoin2HashJoinTest::EresUnittest_Transform),
  };
...
CXformRightOuterJoin2HashJoinTest::EresUnittest_Transform() {
  ...
  CXformRightOuterJoin2HashJoin *xform = GPOS_NEW(mp) CXformRightOuterJoin2HashJoin(mp);
