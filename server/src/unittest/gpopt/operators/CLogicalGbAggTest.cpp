...
CLogicalGbAggTest::EresUnittest_PxfsCandidates() {
  ...
  CLogicalGbAgg *pGlobalGbAgg =
      GPOS_NEW(mp) CLogicalGbAgg(mp, GPOS_NEW(mp) CColRefArray(mp), COperator::EgbaggtypeGlobal);
  ...
  CLogicalGbAgg *pLocalGbAgg =
      GPOS_NEW(mp) CLogicalGbAgg(mp, GPOS_NEW(mp) CColRefArray(mp), COperator::EgbaggtypeLocal);
  ...
  CLogicalGbAgg *pIntermediateGbAgg =
      GPOS_NEW(mp) CLogicalGbAgg(mp, GPOS_NEW(mp) CColRefArray(mp), COperator::EgbaggtypeIntermediate,
                                 false /* fGeneratesDuplicates */, GPOS_NEW(mp) CColRefArray(mp) /*pdrgpcrArgDQA*/);
