...
class CParseHandlerTest {
 private:
  ...
  static GPOS_RESULT EresParseAndSerializePlan(CMemoryPool *, const CHAR *, BOOL fValidate);

  // test parsing and serializing of queries
  static GPOS_RESULT EresParseAndSerializeQuery(CMemoryPool *, const CHAR *, BOOL fValidate);

  // test parsing and serializing of metadata
  static GPOS_RESULT EresParseAndSerializeMetadata(CMemoryPool *, const CHAR *, BOOL fValidate);

  // test parsing and serializing of metadata requests
  static GPOS_RESULT EresParseAndSerializeMDRequest(CMemoryPool *, const CHAR *, BOOL fValidate);

  // test parsing and serializing of stats
  static GPOS_RESULT EresParseAndSerializeStatistics(CMemoryPool *, const CHAR *, BOOL fValidate);

  // test parsing and serializing of scalar expressions
  static GPOS_RESULT EresParseAndSerializeScalarExpr(CMemoryPool *, const CHAR *, BOOL fValidate);
 ...
 public:
  ...
  static GPOS_RESULT EresUnittest_RunAllPositiveTests(const CHAR *rgszFileNames[], ULONG ulFiles,
