...
class CEngineTest {
 ...
 public:
  ...
  static GPOS_RESULT EresOptimize(FnOptimize *pfopt,   // optimization function
  ...
  static void BuildMemoRecursive(CMemoryPool *mp, CExpression *pexprInput, CSearchStageArray *search_stage_array);
