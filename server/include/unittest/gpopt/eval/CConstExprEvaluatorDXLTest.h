...
class CConstExprEvaluatorDXLTest {
 private:
  class CDummyConstDXLNodeEvaluator : public IConstDXLNodeEvaluator {
   ...
   public:
    CDummyConstDXLNodeEvaluator(const CDummyConstDXLNodeEvaluator &) = delete;

    // ctor
    CDummyConstDXLNodeEvaluator(CMemoryPool *mp, CMDAccessor *md_accessor, INT val)
    ...
    gpdxl::CDXLNode *EvaluateExpr(const gpdxl::CDXLNode *pdxlnExpr) override;
