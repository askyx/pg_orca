...
enum { ulong_max = ((::gpos::ULONG)-1) };

using ULLONG = uint64_t;
GPOS_CPL_ASSERT(8 == sizeof(ULLONG), "");
enum { ullong_max = ((::gpos::ULLONG)-1) };
...
enum { int_max = ((::gpos::INT)(gpos::ulong_max >> 1)), int_min = (-gpos::int_max - 1) };

enum { lint_max = ((::gpos::LINT)(gpos::ullong_max >> 1)), lint_min = (-gpos::lint_max - 1) };

enum { usint_max = ((::gpos::USINT)-1) };

enum { sint_max = ((::gpos::SINT)(gpos::usint_max >> 1)), sint_min = (-gpos::sint_max - 1) };
