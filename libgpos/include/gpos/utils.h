...
inline ULONG HashULongPtr(const ULONG_PTR &key) {
  return (ULONG)key;
}
...
inline BOOL EqualULongPtr(const ULONG_PTR &key_left, const ULONG_PTR &key_right) {
