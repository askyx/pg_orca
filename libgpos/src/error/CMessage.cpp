...
//
//---------------------------------------------------------------------------
IOstream &CMessage::OsPrint(IOstream &os) const {
...
CMessage *CMessage::GetMessage(ULONG index) {
  ...
  static CMessage msg[CException::ExmiSentinel] = {
      CMessage(CException(CException::ExmaInvalid, CException::ExmiInvalid), CException::ExsevError,
               GPOS_WSZ_WSZLEN("Unknown error: %ls"),
               1,  // # params
               GPOS_WSZ_WSZLEN("This message is used if no error message "
                               "can be found at handling time")),

      CMessage(CException(CException::ExmaSystem, CException::ExmiAbort), CException::ExsevError,
      ...
      CMessage(CException(CException::ExmaSystem, CException::ExmiOutOfStack), CException::ExsevError,
      ...
      CMessage(CException(CException::ExmaSystem, CException::ExmiOverflow), CException::ExsevError,
               GPOS_WSZ_WSZLEN("Arithmetic Overflow"),
               0,  // # params
               GPOS_WSZ_WSZLEN("Arithmetic Overflow")),

      CMessage(CException(CException::ExmaSystem, CException::ExmiInvalidDeletion), CException::ExsevError,
      ...
      CMessage(CException(CException::ExmaSystem, CException::ExmiDummyWarning), CException::ExsevWarning,
               GPOS_WSZ_WSZLEN("This is a dummy warning"),
               1,  // # params
               GPOS_WSZ_WSZLEN("Used to test warning logging")),

      CMessage(CException(CException::ExmaSQL, CException::ExmiSQLDefault), CException::ExsevError,
               GPOS_WSZ_WSZLEN("Internal error"), 0, GPOS_WSZ_WSZLEN("Internal error")),

      CMessage(CException(CException::ExmaSQL, CException::ExmiSQLNotNullViolation), CException::ExsevError,
      ...
      CMessage(CException(CException::ExmaSQL, CException::ExmiSQLCheckConstraintViolation), CException::ExsevError,
      ...
      CMessage(CException(CException::ExmaUnhandled, CException::ExmiUnhandled), CException::ExsevError,
               GPOS_WSZ_WSZLEN("Unhandled exception"), 0, GPOS_WSZ_WSZLEN("Unhandled exception")),

      CMessage(CException(CException::ExmaInvalid, CException::ExmiORCAInvalidState), CException::ExsevError,
               GPOS_WSZ_WSZLEN("This is an invalid state, please report this error"), 0,
               GPOS_WSZ_WSZLEN("This is an invalid state, please report this error."))};
