...
CHashMapIterTest::EresUnittest_Basic() {
  ...
  using Map = CHashMap<ULONG, ULONG, HashPtr<ULONG>, gpos::Equals<ULONG>, CleanupNULL<ULONG>, CleanupNULL<ULONG>>;

  using MapIter =
      CHashMapIter<ULONG, ULONG, HashPtr<ULONG>, gpos::Equals<ULONG>, CleanupNULL<ULONG>, CleanupNULL<ULONG>>;
