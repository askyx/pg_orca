...
CHashSetIterTest::EresUnittest_Basic() {
  ...
  using UlongHashSet = CHashSet<ULONG, HashValue<ULONG>, gpos::Equals<ULONG>, CleanupNULL<ULONG>>;

  using UlongHashSetIter = CHashSetIter<ULONG, HashValue<ULONG>, gpos::Equals<ULONG>, CleanupNULL<ULONG>>;
