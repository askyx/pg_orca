...
class CParseHandlerScalarConstValue : public CParseHandlerScalarOp {
 ...
 public:
  CParseHandlerScalarConstValue(const CParseHandlerScalarConstValue &) = delete;

  // ctor
  CParseHandlerScalarConstValue(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
