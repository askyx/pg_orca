...
class CParseHandlerScalarPartListNullTest : public CParseHandlerScalarOp {
 ...
 public:
  CParseHandlerScalarPartListNullTest(const CParseHandlerScalarPartListNullTest &) = delete;

  // ctor
  CParseHandlerScalarPartListNullTest(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
