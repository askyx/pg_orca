...
class CParseHandlerScalarSubPlanParamList : public CParseHandlerScalarOp {
 ...
 public:
  CParseHandlerScalarSubPlanParamList(const CParseHandlerScalarSubPlanParamList &) = delete;

  // ctor
  CParseHandlerScalarSubPlanParamList(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
  ...
  CDXLColRefArray *GetDXLColRefArray() const { return m_dxl_colref_array; }
};
