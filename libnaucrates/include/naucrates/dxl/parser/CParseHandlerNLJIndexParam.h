...
class CParseHandlerNLJIndexParam : public CParseHandlerBase {
 ...
 public:
  ...
  // ctor/dtor
  CParseHandlerNLJIndexParam(CMemoryPool *mp, CParseHandlerManager *parse_handler_manager,
                             CParseHandlerBase *parse_handler_root);

  ~CParseHandlerNLJIndexParam() override;

  // return column reference
  CDXLColRef *GetNestParamColRefDxl(void) const { return m_nest_param_colref_dxl; }
};
