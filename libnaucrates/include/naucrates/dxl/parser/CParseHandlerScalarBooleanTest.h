...
class CParseHandlerScalarBooleanTest : public CParseHandlerScalarOp {
 ...
 public:
  CParseHandlerScalarBooleanTest(const CParseHandlerScalarBooleanTest &) = delete;

  // ctor
  CParseHandlerScalarBooleanTest(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
