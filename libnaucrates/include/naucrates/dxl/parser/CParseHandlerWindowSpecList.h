...
class CParseHandlerWindowSpecList : public CParseHandlerBase {
 ...
 public:
  ...
  // ctor
  CParseHandlerWindowSpecList(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr, CParseHandlerBase *pph);

  // list of window keys
  CDXLWindowSpecArray *GetDxlWindowSpecArray() const { return m_window_spec_array; }
};
}  // namespace gpdxl
