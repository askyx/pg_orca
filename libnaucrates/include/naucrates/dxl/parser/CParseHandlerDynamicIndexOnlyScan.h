...
class CParseHandlerDynamicIndexOnlyScan : public CParseHandlerIndexOnlyScan {
 ...
 public:
  CParseHandlerDynamicIndexOnlyScan(const CParseHandlerDynamicIndexOnlyScan &) = delete;

  // ctor
  CParseHandlerDynamicIndexOnlyScan(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
