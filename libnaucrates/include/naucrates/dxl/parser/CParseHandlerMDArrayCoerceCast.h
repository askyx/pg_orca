...
class CParseHandlerMDArrayCoerceCast : public CParseHandlerMetadataObject {
 ...
 public:
  CParseHandlerMDArrayCoerceCast(const CParseHandlerMDArrayCoerceCast &) = delete;

  // ctor
  CParseHandlerMDArrayCoerceCast(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
