...
class CParseHandlerCtasStorageOptions : public CParseHandlerBase {
 ...
 public:
  CParseHandlerCtasStorageOptions(const CParseHandlerCtasStorageOptions &) = delete;

  // ctor
  CParseHandlerCtasStorageOptions(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
