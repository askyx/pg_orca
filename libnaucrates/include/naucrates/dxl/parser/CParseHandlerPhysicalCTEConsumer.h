...
class CParseHandlerPhysicalCTEConsumer : public CParseHandlerPhysicalOp {
 ...
 public:
  CParseHandlerPhysicalCTEConsumer(const CParseHandlerPhysicalCTEConsumer &) = delete;

  // ctor
  CParseHandlerPhysicalCTEConsumer(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
