...
class CParseHandlerExtStatsNDistinct : public CParseHandlerBase {
 ...
 public:
  CParseHandlerExtStatsNDistinct(const CParseHandlerExtStatsNDistinct &) = delete;

  // ctor
  CParseHandlerExtStatsNDistinct(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
