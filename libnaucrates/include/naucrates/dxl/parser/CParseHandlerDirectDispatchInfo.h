...
class CParseHandlerDirectDispatchInfo : public CParseHandlerBase {
 ...
 public:
  CParseHandlerDirectDispatchInfo(const CParseHandlerDirectDispatchInfo &) = delete;

  // ctor
  CParseHandlerDirectDispatchInfo(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
