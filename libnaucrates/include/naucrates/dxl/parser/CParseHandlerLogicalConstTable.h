...
class CParseHandlerLogicalConstTable : public CParseHandlerLogicalOp {
 ...
 public:
  CParseHandlerLogicalConstTable(const CParseHandlerLogicalConstTable &) = delete;

  // ctor/dtor
  CParseHandlerLogicalConstTable(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
