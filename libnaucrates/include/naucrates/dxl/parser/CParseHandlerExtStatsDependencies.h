...
class CParseHandlerExtStatsDependencies : public CParseHandlerBase {
 ...
 public:
  CParseHandlerExtStatsDependencies(const CParseHandlerExtStatsDependencies &) = delete;

  // ctor
  CParseHandlerExtStatsDependencies(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
