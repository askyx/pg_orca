...
class CParseHandlerLogicalCTEConsumer : public CParseHandlerLogicalOp {
 ...
 public:
  CParseHandlerLogicalCTEConsumer(const CParseHandlerLogicalCTEConsumer &) = delete;

  // ctor
  CParseHandlerLogicalCTEConsumer(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
