...
class CParseHandlerPhysicalDynamicBitmapTableScan : public CParseHandlerPhysicalAbstractBitmapScan {
 ...
 public:
  CParseHandlerPhysicalDynamicBitmapTableScan(const CParseHandlerPhysicalDynamicBitmapTableScan &) = delete;

  // ctor
  CParseHandlerPhysicalDynamicBitmapTableScan(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
