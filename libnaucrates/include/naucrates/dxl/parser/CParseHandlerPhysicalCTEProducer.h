...
class CParseHandlerPhysicalCTEProducer : public CParseHandlerPhysicalOp {
 ...
 public:
  CParseHandlerPhysicalCTEProducer(const CParseHandlerPhysicalCTEProducer &) = delete;

  // ctor
  CParseHandlerPhysicalCTEProducer(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
