...
class CParseHandlerWindowKeyList : public CParseHandlerBase {
 ...
 public:
  ...
  // ctor
  CParseHandlerWindowKeyList(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
                             CParseHandlerBase *parse_handler_root);

  // list of window keys
  CDXLWindowKeyArray *GetDxlWindowKeyArray() const { return m_dxl_window_key_array; }
};
}  // namespace gpdxl
