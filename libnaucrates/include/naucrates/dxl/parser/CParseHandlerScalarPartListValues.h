...
class CParseHandlerScalarPartListValues : public CParseHandlerScalarOp {
 ...
 public:
  CParseHandlerScalarPartListValues(const CParseHandlerScalarPartListValues &) = delete;

  // ctor
  CParseHandlerScalarPartListValues(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
