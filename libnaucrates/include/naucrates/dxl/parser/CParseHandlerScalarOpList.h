...
class CParseHandlerScalarOpList : public CParseHandlerScalarOp {
 private:
  ...
  static CDXLScalarOpList::EdxlOpListType GetDXLOpListType(const XMLCh *const element_local_name);
 ...
 public:
  ...
  // ctor
  CParseHandlerScalarOpList(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
