...
class CParseHandlerLogicalCTEAnchor : public CParseHandlerLogicalOp {
 ...
 public:
  CParseHandlerLogicalCTEAnchor(const CParseHandlerLogicalCTEAnchor &) = delete;

  // ctor
  CParseHandlerLogicalCTEAnchor(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
