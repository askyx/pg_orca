...
class CParseHandlerScalarValuesList : public CParseHandlerOp {
 ...
 public:
  CParseHandlerScalarValuesList(const CParseHandlerScalarValuesList &) = delete;

  // ctor/dtor
  CParseHandlerScalarValuesList(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
