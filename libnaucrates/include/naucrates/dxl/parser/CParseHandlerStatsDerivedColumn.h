...
class CParseHandlerStatsDerivedColumn : public CParseHandlerBase {
 ...
 public:
  CParseHandlerStatsDerivedColumn(const CParseHandlerStatsDerivedColumn &) = delete;

  // ctor
  CParseHandlerStatsDerivedColumn(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
  ...
  // derived column stats
  CDXLStatsDerivedColumn *GetDxlStatsDerivedCol() const { return m_dxl_stats_derived_col; }
};
}  // namespace gpdxl
