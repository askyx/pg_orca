...
class CParseHandlerExtStatsDependency : public CParseHandlerBase {
 ...
 public:
  CParseHandlerExtStatsDependency(const CParseHandlerExtStatsDependency &) = delete;

  // ctor
  CParseHandlerExtStatsDependency(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
