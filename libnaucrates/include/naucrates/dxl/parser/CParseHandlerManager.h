...
class CParseHandlerManager {
 ...
 public:
  ...
  CDXLMemoryManager *GetDXLMemoryManager() { return m_dxl_memory_manager; }
  ...
  void ReplaceHandler(CParseHandlerBase *parse_handler_new, CParseHandlerBase *parse_handler_root);
