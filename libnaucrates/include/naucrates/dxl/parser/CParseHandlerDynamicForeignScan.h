...
class CParseHandlerDynamicForeignScan : public CParseHandlerPhysicalOp {
 ...
 public:
  CParseHandlerDynamicForeignScan(const CParseHandlerDynamicForeignScan &) = delete;

  // ctor
  CParseHandlerDynamicForeignScan(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr, CParseHandlerBase *pph);
};
}  // namespace gpdxl
