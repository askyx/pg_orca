...
class CParseHandlerScalarFieldSelect : public CParseHandlerScalarOp {
 ...
 public:
  CParseHandlerScalarFieldSelect(const CParseHandlerScalarFieldSelect &) = delete;

  // ctor/dtor
  CParseHandlerScalarFieldSelect(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
