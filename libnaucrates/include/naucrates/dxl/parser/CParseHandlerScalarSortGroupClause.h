...
class CParseHandlerScalarSortGroupClause : public CParseHandlerScalarOp {
 ...
 public:
  CParseHandlerScalarSortGroupClause(const CParseHandlerScalarSortGroupClause &) = delete;

  // ctor/dtor
  CParseHandlerScalarSortGroupClause(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
