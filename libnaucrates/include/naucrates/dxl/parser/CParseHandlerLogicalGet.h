...
class CParseHandlerLogicalGet : public CParseHandlerLogicalOp {
 ...
 protected:
  ...
  void StartElement(const XMLCh *const element_local_name, Edxltoken token_type, const Attributes &attr);
 ...
 public:
  ...
  // ctor
  CParseHandlerLogicalGet(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
