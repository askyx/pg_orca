...
class CParseHandlerExtStatsNDistinctList : public CParseHandlerBase {
 ...
 public:
  CParseHandlerExtStatsNDistinctList(const CParseHandlerExtStatsNDistinctList &) = delete;

  // ctor
  CParseHandlerExtStatsNDistinctList(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
