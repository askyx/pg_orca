...
class CDXLDatumInt8 : public CDXLDatum {
 ...
 public:
  ...
  // ctor
  CDXLDatumInt8(CMemoryPool *mp, IMDId *mdid_type, bool is_null, int64_t val);
  ...
  // datum type
  EdxldatumType GetDatumType() const override { return CDXLDatum::EdxldatumInt8; }

  // conversion function
  static CDXLDatumInt8 *Cast(CDXLDatum *dxl_datum) {
