...
enum Edxlis { EdxlisIndexProjList = 0, EdxlisIndexFilter, EdxlisIndexCondition, EdxlisSentinel };
...
class CDXLPhysicalIndexScan : public CDXLPhysical {
 ...
 public:
  ...
  // ctor
  CDXLPhysicalIndexScan(CMemoryPool *mp, CDXLTableDescr *table_descr, CDXLIndexDescr *dxl_index_descr,
