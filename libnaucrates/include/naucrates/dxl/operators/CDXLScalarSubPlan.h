...
enum EdxlSubPlan { EdxlSubPlanIndexChildPlan, EdxlSubPlanIndexSentinel };
...
class CDXLScalarSubPlan : public CDXLScalar {
 ...
 public:
  ...
  // Operator type
  Edxlopid GetDXLOperator() const override { return EdxlopScalarSubPlan; }
  ...
  // outer references
  const CDXLColRefArray *GetDxlOuterColRefsArray() const { return m_dxl_colref_array; }

  // return subplan type
  EdxlSubPlanType GetDxlSubplanType() const { return m_dxl_subplan_type; }
