...
enum EdxlBoolExprType { Edxland, Edxlor, Edxlnot, EdxlBoolExprTypeSentinel };
...
class CDXLScalarBoolExpr : public CDXLScalar {
 ...
 public:
  ...
  // ctor/dtor
  explicit CDXLScalarBoolExpr(CMemoryPool *mp, const EdxlBoolExprType bool_type);
  ...
  // conversion function
  static CDXLScalarBoolExpr *Cast(CDXLOperator *dxl_op) {
