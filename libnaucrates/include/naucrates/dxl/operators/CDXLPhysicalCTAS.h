...
class CDXLPhysicalCTAS : public CDXLPhysical {
 ...
 public:
  ...
  // ctor
  CDXLPhysicalCTAS(CMemoryPool *mp, CMDName *mdname_schema, CMDName *mdname_rel, CDXLColDescrArray *dxl_col_descr_array,
                   CDXLCtasStorageOptions *dxl_ctas_storage_options, IMDRelation::Ereldistrpolicy rel_distr_policy,
                   ULongPtrArray *distr_column_pos_array, IMdIdArray *distr_opclasses, BOOL is_temporary,
  ...
  // conversion function
  static CDXLPhysicalCTAS *Cast(CDXLOperator *dxl_op) {
