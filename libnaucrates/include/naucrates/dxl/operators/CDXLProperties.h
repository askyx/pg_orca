...
enum Edxlproperty { EdxlpropertyLogical, EdxlpropertyPhysical, EdxlpropertySentinel };
...
class CDXLProperties : public CRefCount {
 ...
 public:
  ...
  virtual Edxlproperty GetDXLPropertyType() const { return EdxlpropertyLogical; }
