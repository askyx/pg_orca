...
class CDXLPhysicalRedistributeMotion : public CDXLPhysicalMotion {
 ...
 public:
  CDXLPhysicalRedistributeMotion(const CDXLPhysicalRedistributeMotion &) = delete;
  ...
  ULONG
  GetRelationChildIdx() const override { return EdxlrmIndexChild; }

  // serialize operator in DXL format
  void SerializeToDXL(CXMLSerializer *xml_serializer, const CDXLNode *dxlnode) const override;

  // conversion function
  static CDXLPhysicalRedistributeMotion *Cast(CDXLOperator *dxl_op) {
