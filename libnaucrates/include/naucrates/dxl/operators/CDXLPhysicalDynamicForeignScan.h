...
enum Edxldfs { EdxldfsIndexProjList = 0, EdxldfsIndexFilter, EdxldfsSentinel };
...
class CDXLPhysicalDynamicForeignScan : public CDXLPhysical {
 ...
 public:
  ...
  // ctor
  CDXLPhysicalDynamicForeignScan(CMemoryPool *mp, CDXLTableDescr *table_descr, IMdIdArray *part_mdids,
  ...
  // conversion function
  static CDXLPhysicalDynamicForeignScan *Cast(CDXLOperator *dxl_op) {
    GPOS_ASSERT(nullptr != dxl_op);
    GPOS_ASSERT(EdxlopPhysicalDynamicForeignScan == dxl_op->GetDXLOperator());
