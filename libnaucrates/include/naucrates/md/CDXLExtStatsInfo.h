...
class CDXLExtStatsInfo : public IMDExtStatsInfo {
 ...
 public:
  ...
  CDXLExtStatsInfo(CMemoryPool *mp, IMDId *rel_stats_mdid, CMDName *mdname, CMDExtStatsInfoArray *extstats_info_array);
  ...
  // dummy relstats
  static CDXLExtStatsInfo *CreateDXLDummyExtStatsInfo(CMemoryPool *mp, IMDId *mdid);
};
