...
class CMDRequest : public CRefCount {
 public:
  ...
  struct SMDTypeRequest {
    ...
    // ctor
    SMDTypeRequest(CSystemId sysid, IMDType::ETypeInfo type_info) : m_sysid(sysid), m_type_info(type_info) {}
  };
 ...
 public:
  ...
  // ctor
  CMDRequest(CMemoryPool *mp, IMdIdArray *mdid_array, SMDTypeRequestArray *mdtype_request_array);
  ...
  // array of mdids
  IMdIdArray *GetMdIdArray() const { return m_mdid_array; }
