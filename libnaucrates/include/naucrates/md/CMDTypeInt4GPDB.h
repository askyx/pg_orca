...
class CMDTypeInt4GPDB : public IMDTypeInt4 {
 ...
 public:
  ...
  IDatumInt4 *CreateInt4Datum(CMemoryPool *mp, int32_t iValue, bool is_null) const override;
  ...
  uint32_t Length() const override { return GPDB_INT4_LENGTH; }

  // return the GPDB length
  virtual int32_t GetGPDBLength() const { return GPDB_INT4_LENGTH; }
