...
class CLeftAntiSemiJoinStatsProcessor : public CJoinStatsProcessor {
 public:
  ...
  static void JoinHistogramsLASJ(const CHistogram *histogram1, const CHistogram *histogram2, CStatsPredJoin *join_stats,
  ...
  static CDouble NullFreqLASJ(CStatsPred::EStatsCmpType stats_cmp_type, const CHistogram *outer_histogram,
