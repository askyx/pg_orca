...
class CLeftOuterJoinStatsProcessor : public CJoinStatsProcessor {
 private:
  ...
  static UlongToHistogramMap *MakeLOJHistogram(CMemoryPool *mp, const CStatistics *outer_stats,
  ...
  static void AddHistogramsLOJInner(CMemoryPool *mp, const CStatistics *inner_join_stats,
 ...
 public:
  static CStatistics *CalcLOJoinStatsStatic(CMemoryPool *mp, const IStatistics *outer_stats,
