...
class CStatisticsUtils {
 private:
  ...
  static void SplitHistDriver(CMemoryPool *mp, const CBucket *histogram_bucket, const CBucketArray *mcv_buckets,
                              CBucketArray *merged_buckets, ULONG *mcv_index, ULONG mcv);
 ...
 public:
  ...
  static CHistogram *TransformMCVToHist(CMemoryPool *mp, const IMDType *mdtype, IDatumArray *mcv_datums,
                                        CDoubleArray *freq_array, ULONG num_mcv_values);
  ...
  static void PrintColStats(CMemoryPool *mp, CStatsPred *pred_stats, ULONG cond_colid, CHistogram *histogram,
  ...
  static void AddHistogram(CMemoryPool *mp, ULONG colid, const CHistogram *histogram,
...
// comparison function for sorting MCVs
INT CStatisticsUtils::GetMcvPairCmpFunc(const void *val1, const void *val2) {
