...
CMDRelationGPDB::CMDRelationGPDB(CMemoryPool *mp, IMDId *mdid, CMDName *mdname, BOOL fTemporary,
  ...
  GPOS_ASSERT(nullptr == distr_opfamilies || distr_opfamilies->Size() == m_distr_col_array->Size());
...
IMDRelation::Erelaoversion CMDRelationGPDB::GetRelAOVersion() const {
...
//
//---------------------------------------------------------------------------
IMDRelation::Ereldistrpolicy CMDRelationGPDB::GetRelDistribution() const {
...
//
//---------------------------------------------------------------------------
const IMDColumn *CMDRelationGPDB::GetDistrColAt(ULONG pos) const {
...
IMDId *CMDRelationGPDB::GetDistrOpfamilyAt(ULONG pos) const {
