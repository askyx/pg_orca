...
//
//---------------------------------------------------------------------------
CDXLPhysicalDynamicForeignScan::CDXLPhysicalDynamicForeignScan(CMemoryPool *mp, CDXLTableDescr *table_descr,
...
//
//---------------------------------------------------------------------------
Edxlopid CDXLPhysicalDynamicForeignScan::GetDXLOperator() const {
...
//
//---------------------------------------------------------------------------
const CWStringConst *CDXLPhysicalDynamicForeignScan::GetOpNameStr() const {
...
//
//---------------------------------------------------------------------------
const CDXLTableDescr *CDXLPhysicalDynamicForeignScan::GetDXLTableDescr() const {
  return m_dxl_table_descr;
}

IMdIdArray *CDXLPhysicalDynamicForeignScan::GetParts() const {
  return m_part_mdids;
}
...
//
//---------------------------------------------------------------------------
void CDXLPhysicalDynamicForeignScan::SerializeToDXL(CXMLSerializer *xml_serializer, const CDXLNode *node) const {
  ...
  xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenForeignServerOid), m_foreign_server_oid);
...
//
//---------------------------------------------------------------------------
void CDXLPhysicalDynamicForeignScan::AssertValid(const CDXLNode *node,
