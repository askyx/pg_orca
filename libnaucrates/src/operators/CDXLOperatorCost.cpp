...
CDXLOperatorCost::CDXLOperatorCost(CWStringDynamic *startup_cost_str, CWStringDynamic *total_cost_str,
...
const CWStringDynamic *CDXLOperatorCost::GetStartUpCostStr() const {
  return m_startup_cost_str;
}

const CWStringDynamic *CDXLOperatorCost::GetTotalCostStr() const {
  return m_total_cost_str;
}

const CWStringDynamic *CDXLOperatorCost::GetRowsOutStr() const {
  return m_rows_out_str;
}

const CWStringDynamic *CDXLOperatorCost::GetWidthStr() const {
  return m_width_str;
}
...
//
//---------------------------------------------------------------------------
void CDXLOperatorCost::SetRows(CWStringDynamic *rows_str) {
...
//
//---------------------------------------------------------------------------
void CDXLOperatorCost::SetCost(CWStringDynamic *cost_str) {
