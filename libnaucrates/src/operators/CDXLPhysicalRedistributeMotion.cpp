...
//
//---------------------------------------------------------------------------
CDXLPhysicalRedistributeMotion::CDXLPhysicalRedistributeMotion(CMemoryPool *mp, BOOL is_duplicate_sensitive)
...
//
//---------------------------------------------------------------------------
Edxlopid CDXLPhysicalRedistributeMotion::GetDXLOperator() const {
...
//
//---------------------------------------------------------------------------
const CWStringConst *CDXLPhysicalRedistributeMotion::GetOpNameStr() const {
...
//
//---------------------------------------------------------------------------
void CDXLPhysicalRedistributeMotion::SerializeToDXL(CXMLSerializer *xml_serializer, const CDXLNode *dxlnode) const {
...
//
//---------------------------------------------------------------------------
void CDXLPhysicalRedistributeMotion::AssertValid(const CDXLNode *dxlnode, BOOL validate_children) const {
