...
//
//---------------------------------------------------------------------------
CDXLPhysicalHashJoin::CDXLPhysicalHashJoin(CMemoryPool *mp, EdxlJoinType join_type) : CDXLPhysicalJoin(mp, join_type) {}
...
//
//---------------------------------------------------------------------------
Edxlopid CDXLPhysicalHashJoin::GetDXLOperator() const {
