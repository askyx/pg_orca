...
//
//---------------------------------------------------------------------------
CDXLLogicalCTAS::CDXLLogicalCTAS(CMemoryPool *mp, IMDId *mdid, CMDName *mdname_schema, CMDName *mdname_rel,
                                 ...
                                 IMdIdArray *distr_opfamilies, IMdIdArray *distr_opclasses, BOOL is_temporary,
  ...
  GPOS_ASSERT_IFF(IMDRelation::EreldistrHash == rel_distr_policy, nullptr != distr_column_pos_array);
  ...
  GPOS_ASSERT(nullptr == m_distr_column_pos_array || m_distr_opfamilies->Size() == m_distr_column_pos_array->Size());
  GPOS_ASSERT(nullptr == m_distr_column_pos_array || m_distr_opclasses->Size() == m_distr_column_pos_array->Size());
}
...
//
//---------------------------------------------------------------------------
Edxlopid CDXLLogicalCTAS::GetDXLOperator() const {
...
//
//---------------------------------------------------------------------------
const CWStringConst *CDXLLogicalCTAS::GetOpNameStr() const {
...
//
//---------------------------------------------------------------------------
BOOL CDXLLogicalCTAS::IsColDefined(ULONG colid) const {
...
//
//---------------------------------------------------------------------------
void CDXLLogicalCTAS::AssertValid(const CDXLNode *dxlnode, BOOL validate_children) const {
