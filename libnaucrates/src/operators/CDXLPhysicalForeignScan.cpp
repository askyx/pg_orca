...
//
//---------------------------------------------------------------------------
CDXLPhysicalForeignScan::CDXLPhysicalForeignScan(CMemoryPool *mp) : CDXLPhysicalTableScan(mp) {}
...
//
//---------------------------------------------------------------------------
CDXLPhysicalForeignScan::CDXLPhysicalForeignScan(CMemoryPool *mp, CDXLTableDescr *table_descr)
...
//
//---------------------------------------------------------------------------
Edxlopid CDXLPhysicalForeignScan::GetDXLOperator() const {
...
//
//---------------------------------------------------------------------------
const CWStringConst *CDXLPhysicalForeignScan::GetOpNameStr() const {
