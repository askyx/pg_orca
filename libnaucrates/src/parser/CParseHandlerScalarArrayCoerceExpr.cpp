...
//
//---------------------------------------------------------------------------
CParseHandlerScalarArrayCoerceExpr::CParseHandlerScalarArrayCoerceExpr(CMemoryPool *mp,
...
//
//---------------------------------------------------------------------------
void CParseHandlerScalarArrayCoerceExpr::StartElement(const XMLCh *const,  // element_uri,
  ...
  if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenScalarArrayCoerceExpr), element_local_name)) {
    ...
    CDXLScalarArrayCoerceExpr *dxl_op = (CDXLScalarArrayCoerceExpr *)CDXLOperatorFactory::MakeDXLArrayCoerceExpr(
    ...
    CParseHandlerBase *exprelem_parse_handler = CParseHandlerFactory::GetParseHandler(
        m_mp, CDXLTokens::XmlstrToken(EdxltokenScalar), m_parse_handler_mgr, this);
...
//
//---------------------------------------------------------------------------
void CParseHandlerScalarArrayCoerceExpr::EndElement(const XMLCh *const,  // element_uri,
                                                    const XMLCh *const element_local_name,
                                                    const XMLCh *const  // element_qname
) {
  if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenScalarArrayCoerceExpr), element_local_name)) {
  ...
  CParseHandlerScalarOp *elemexpr_parse_handler = dynamic_cast<CParseHandlerScalarOp *>((*this)[1]);
