...
CParseHandlerFactory::TokenParseHandlerFuncMap *CParseHandlerFactory::m_token_parse_handler_func_map = nullptr;

// adds a new mapping of token to corresponding parse handler
void CParseHandlerFactory::AddMapping(Edxltoken token_type, ParseHandlerOpCreatorFunc *parse_handler_op_func) {
  ...
  BOOL success GPOS_ASSERTS_ONLY = m_token_parse_handler_func_map->Insert(token_identifier_str, parse_handler_op_func);

  GPOS_ASSERT(success);
}

// initialize mapping of tokens to parse handlers
void CParseHandlerFactory::Init(CMemoryPool *mp) {
  ...
  SParseHandlerMapping token_parse_handler_map[] = {
      ...
      {EdxltokenPhysicalDynamicIndexOnlyScan, &CreateDynamicIdxOnlyScanParseHandler},
...
CParseHandlerBase *CParseHandlerFactory::GetParseHandler(CMemoryPool *mp, const XMLCh *token_identifier_str,
...
CParseHandlerDXL *CParseHandlerFactory::GetParseHandlerDXL(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr) {
  return GPOS_NEW(mp) CParseHandlerDXL(mp, parse_handler_mgr);
}

// creates a parse handler for parsing a Plan
CParseHandlerBase *CParseHandlerFactory::CreatePlanParseHandler(CMemoryPool *mp,
                                                                CParseHandlerManager *parse_handler_mgr,
                                                                CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMetadataParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDRequestParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateTraceFlagsParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateOptimizerCfgParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateEnumeratorCfgParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateStatisticsCfgParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateCTECfgParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateCostModelCfgParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateHintParseHandler(CMemoryPool *mp,
                                                                CParseHandlerManager *parse_handler_mgr,
                                                                CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePlanHintParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerPlanHint(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing window oids configuration
CParseHandlerBase *CParseHandlerFactory::CreateWindowOidsParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDRelationParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDRelationCTASParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDIndexParseHandler(CMemoryPool *mp,
                                                                   CParseHandlerManager *parse_handler_mgr,
                                                                   CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateRelStatsParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
// creates a parse handler for parsing relation stats
CParseHandlerBase *CParseHandlerFactory::CreateRelationExtStatsParseHandler(CMemoryPool *mp,
                                                                            CParseHandlerManager *parse_handler_mgr,
                                                                            CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerRelationExtendedStats(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing relation stats
CParseHandlerBase *CParseHandlerFactory::CreateExtStatsParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerExtStats(mp, parse_handler_mgr, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateExtStatsInfoParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerExtStatsInfo(mp, parse_handler_mgr, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateExtStatsDependenciesParseHandler(CMemoryPool *mp,
                                                                                CParseHandlerManager *parse_handler_mgr,
                                                                                CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerExtStatsDependencies(mp, parse_handler_mgr, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateExtStatsDependencyParseHandler(CMemoryPool *mp,
                                                                              CParseHandlerManager *parse_handler_mgr,
                                                                              CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerExtStatsDependency(mp, parse_handler_mgr, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateExtStatsNDistinctListParseHandler(
    CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr, CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerExtStatsNDistinctList(mp, parse_handler_mgr, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateExtStatsNDistinctParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerExtStatsNDistinct(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing column stats
CParseHandlerBase *CParseHandlerFactory::CreateColStatsParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateColStatsBucketParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDTypeParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDScalarOpParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDFuncParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDAggParseHandler(CMemoryPool *mp,
                                                                 CParseHandlerManager *parse_handler_mgr,
                                                                 CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDCastParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDScCmpParseHandler(CMemoryPool *mp,
                                                                   CParseHandlerManager *parse_handler_mgr,
                                                                   CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDIdListParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDColsParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerMetadataColumns(mp, parse_handler_mgr, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateMDIndexInfoListParseHandler(CMemoryPool *mp,
                                                                           CParseHandlerManager *parse_handler_mgr,
                                                                           CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDColParseHandler(CMemoryPool *mp,
                                                                 CParseHandlerManager *parse_handler_mgr,
                                                                 CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePhysicalOpParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScalarOpParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePropertiesParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateFilterParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateTableScanParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateBitmapTableScanParseHandler(CMemoryPool *mp,
                                                                           CParseHandlerManager *parse_handler_mgr,
                                                                           CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateDynBitmapTableScanParseHandler(CMemoryPool *mp,
                                                                              CParseHandlerManager *parse_handler_mgr,
                                                                              CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateForeignScanParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerForeignScan(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing a result node
CParseHandlerBase *CParseHandlerFactory::CreateResultParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateHashJoinParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateNLJoinParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMergeJoinParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateSortParseHandler(CMemoryPool *mp,
                                                                CParseHandlerManager *parse_handler_mgr,
                                                                CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateAppendParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMaterializeParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateDTSParseHandler(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
                                                               CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateDynamicIdxScanParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateDynamicIdxOnlyScanParseHandler(CMemoryPool *mp,
                                                                              CParseHandlerManager *parse_handler_mgr,
                                                                              CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerDynamicIndexOnlyScan(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing a dynamic table scan operator
CParseHandlerBase *CParseHandlerFactory::CreateDFSParseHandler(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
                                                               CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerDynamicForeignScan(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing a partition selector operator
CParseHandlerBase *CParseHandlerFactory::CreatePartitionSelectorParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateSequenceParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLimitParseHandler(CMemoryPool *mp,
                                                                 CParseHandlerManager *parse_handler_mgr,
                                                                 CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLimitCountParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScSubqueryParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScBitmapBoolOpParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScArrayParseHandler(CMemoryPool *mp,
                                                                   CParseHandlerManager *parse_handler_mgr,
                                                                   CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScArrayRefParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScArrayRefIdxListParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScAssertConstraintListParseHandler(
    CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr, CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScDMLActionParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScOpListParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateDirectDispatchParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
// creates a parse handler for parsing a Limit Count operator
CParseHandlerBase *CParseHandlerFactory::CreateLimitOffsetParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateGatherMotionParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateBroadcastMotionParseHandler(CMemoryPool *mp,
                                                                           CParseHandlerManager *parse_handler_mgr,
                                                                           CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateRedistributeMotionParseHandler(CMemoryPool *mp,
                                                                              CParseHandlerManager *parse_handler_mgr,
                                                                              CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateRoutedMotionParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateRandomMotionParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateAggParseHandler(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
                                                               CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateAggRefParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
// operator
CParseHandlerBase *CParseHandlerFactory::CreateGroupingColListParseHandler(CMemoryPool *mp,
                                                                           CParseHandlerManager *parse_handler_mgr,
                                                                           CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScCmpParseHandler(CMemoryPool *mp,
                                                                 CParseHandlerManager *parse_handler_mgr,
                                                                 CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateDistinctCmpParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScIdParseHandler(CMemoryPool *mp,
                                                                CParseHandlerManager *parse_handler_mgr,
                                                                CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScFuncExprParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScOpExprParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScParamParseHandler(CMemoryPool *mp,
                                                                   CParseHandlerManager *parse_handler_mgr,
                                                                   CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerScalarParam(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing a scalar OpExpr
CParseHandlerBase *CParseHandlerFactory::CreateScArrayCmpParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScBoolExprParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScMinMaxParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateBooleanTestParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScNullTestParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScNullIfParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScCastParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScCoerceToDomainParseHandler(CMemoryPool *mp,
                                                                            CParseHandlerManager *parse_handler_mgr,
                                                                            CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScCoerceViaIOParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScArrayCoerceExprParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScalarFieldSelectParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerScalarFieldSelect(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing a SubPlan.
CParseHandlerBase *CParseHandlerFactory::CreateScSubPlanParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScSubPlanTestExprParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScSubPlanParamListParseHandler(CMemoryPool *mp,
                                                                              CParseHandlerManager *parse_handler_mgr,
                                                                              CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScSubPlanParamParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalTVFParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePhysicalTVFParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScCoalesceParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScSwitchParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScSwitchCaseParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScCaseTestParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScConstValueParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateIfStmtParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateProjListParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateProjElemParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateHashExprListParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
// motion node
CParseHandlerBase *CParseHandlerFactory::CreateHashExprParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
// merge join node
CParseHandlerBase *CParseHandlerFactory::CreateCondListParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateSortColListParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateSortColParseHandler(CMemoryPool *mp,
                                                                   CParseHandlerManager *parse_handler_mgr,
                                                                   CParseHandlerBase *parse_handler_root) {
...
// operator
CParseHandlerBase *CParseHandlerFactory::CreateCostParseHandler(CMemoryPool *mp,
                                                                CParseHandlerManager *parse_handler_mgr,
                                                                CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateTableDescParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateColDescParseHandler(CMemoryPool *mp,
                                                                   CParseHandlerManager *parse_handler_mgr,
                                                                   CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateIdxScanListParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateIdxOnlyScanParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateBitmapIdxProbeParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
// index scan node
CParseHandlerBase *CParseHandlerFactory::CreateIdxDescrParseHandler(CMemoryPool *mp,
                                                                    CParseHandlerManager *parse_handler_mgr,
                                                                    CParseHandlerBase *parse_handler_root) {
...
// index scan node
CParseHandlerBase *CParseHandlerFactory::CreateIdxCondListParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateQueryParseHandler(CMemoryPool *mp,
                                                                 CParseHandlerManager *parse_handler_mgr,
                                                                 CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalOpParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalGetParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalForeignGetParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerLogicalForeignGet(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing a logical project operator
CParseHandlerBase *CParseHandlerFactory::CreateLogicalProjParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalCTEProdParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalCTEConsParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalCTEAnchorParseHandler(CMemoryPool *mp,
                                                                            CParseHandlerManager *parse_handler_mgr,
                                                                            CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateCTEListParseHandler(CMemoryPool *mp,
                                                                   CParseHandlerManager *parse_handler_mgr,
                                                                   CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalSetOpParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalSelectParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalJoinParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalQueryOpParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalGrpByParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalLimitParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalConstTableParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScScalarSubqueryQuantifiedParseHandler(
    CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr, CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScScalarSubqueryExistsParseHandler(
    CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr, CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateStatsParseHandler(CMemoryPool *mp,
                                                                 CParseHandlerManager *parse_handler_mgr,
                                                                 CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateStackTraceParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
// creates a parse handler for parsing relation statistics
CParseHandlerBase *CParseHandlerFactory::CreateStatsDrvdRelParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateStatsDrvdColParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateStatsBucketBoundParseHandler(CMemoryPool *mp,
                                                                            CParseHandlerManager *parse_handler_mgr,
                                                                            CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateWindowParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateWindowRefParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateWindowFrameParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateWindowKeyParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateWindowKeyListParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateWindowSpecParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateWindowSpecListParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalWindowParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalInsertParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalDeleteParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalUpdateParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateLogicalCTASParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePhysicalCTASParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateCTASOptionsParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePhysicalCTEProdParseHandler(CMemoryPool *mp,
                                                                           CParseHandlerManager *parse_handler_mgr,
                                                                           CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePhysicalCTEConsParseHandler(CMemoryPool *mp,
                                                                           CParseHandlerManager *parse_handler_mgr,
                                                                           CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePhysicalDMLParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePhysicalSplitParseHandler(CMemoryPool *mp,
                                                                         CParseHandlerManager *parse_handler_mgr,
                                                                         CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreatePhysicalAssertParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateFrameTrailingEdgeParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerScalarWindowFrameEdge(mp, parse_handler_mgr, parse_handler_root);
}

// creates a leading window frame edge parser
CParseHandlerBase *CParseHandlerFactory::CreateFrameLeadingEdgeParseHandler(CMemoryPool *mp,
                                                                            CParseHandlerManager *parse_handler_mgr,
                                                                            CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerScalarWindowFrameEdge(mp, parse_handler_mgr, parse_handler_root);
}
...
CParseHandlerBase *CParseHandlerFactory::CreateSearchStrategyParseHandler(CMemoryPool *mp,
                                                                          CParseHandlerManager *parse_handler_mgr,
                                                                          CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateSearchStageParseHandler(CMemoryPool *mp,
                                                                       CParseHandlerManager *parse_handler_mgr,
                                                                       CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateXformParseHandler(CMemoryPool *mp,
                                                                 CParseHandlerManager *parse_handler_mgr,
                                                                 CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateCostParamsParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateCostParamParseHandler(CMemoryPool *mp,
                                                                     CParseHandlerManager *parse_handler_mgr,
                                                                     CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScExprParseHandler(CMemoryPool *mp,
                                                                  CParseHandlerManager *parse_handler_mgr,
                                                                  CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDChkConstraintParseHandler(CMemoryPool *mp,
                                                                           CParseHandlerManager *parse_handler_mgr,
                                                                           CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateScValuesListParseHandler(CMemoryPool *mp,
                                                                        CParseHandlerManager *parse_handler_mgr,
                                                                        CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerScalarValuesList(mp, parse_handler_mgr, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateScSortGroupClauseParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerScalarSortGroupClause(mp, parse_handler_mgr, parse_handler_root);
}

// creates a parse handler for parsing a Values Scan operator
CParseHandlerBase *CParseHandlerFactory::CreateValuesScanParseHandler(CMemoryPool *mp,
                                                                      CParseHandlerManager *parse_handler_mgr,
                                                                      CParseHandlerBase *parse_handler_root) {
...
CParseHandlerBase *CParseHandlerFactory::CreateMDArrayCoerceCastParseHandler(CMemoryPool *mp,
                                                                             CParseHandlerManager *parse_handler_mgr,
                                                                             CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerMDArrayCoerceCast(mp, parse_handler_mgr, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateNLJIndexParamListParseHandler(
    CMemoryPool *mp, CParseHandlerManager *parse_handler_manager, CParseHandlerBase *parse_handler_root) {
  return GPOS_NEW(mp) CParseHandlerNLJIndexParamList(mp, parse_handler_manager, parse_handler_root);
}

CParseHandlerBase *CParseHandlerFactory::CreateNLJIndexParamParseHandler(CMemoryPool *mp,
