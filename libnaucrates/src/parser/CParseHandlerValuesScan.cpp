...
//	ctor
CParseHandlerValuesScan::CParseHandlerValuesScan(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
                                                 CParseHandlerBase *parse_handler_root)
    : CParseHandlerPhysicalOp(mp, parse_handler_mgr, parse_handler_root) {}

//	processes a Xerces start element event
void CParseHandlerValuesScan::StartElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
...
void CParseHandlerValuesScan::EndElement(const XMLCh *const,  // element_uri,
