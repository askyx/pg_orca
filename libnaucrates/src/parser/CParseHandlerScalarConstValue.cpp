...
//
//---------------------------------------------------------------------------
CParseHandlerScalarConstValue::CParseHandlerScalarConstValue(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
...
//
//---------------------------------------------------------------------------
void CParseHandlerScalarConstValue::StartElement(const XMLCh *const,  // element_uri,
  ...
  CDXLScalarConstValue *dxl_op =
      (CDXLScalarConstValue *)CDXLOperatorFactory::MakeDXLConstValue(m_parse_handler_mgr->GetDXLMemoryManager(), attrs);
...
//
//---------------------------------------------------------------------------
void CParseHandlerScalarConstValue::EndElement(const XMLCh *const,  // element_uri,
                                               const XMLCh *const element_local_name,
                                               const XMLCh *const  // element_qname
) {
  if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenScalarConstValue), element_local_name)) {
