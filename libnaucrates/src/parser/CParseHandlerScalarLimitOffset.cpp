...
//
//---------------------------------------------------------------------------
CParseHandlerScalarLimitOffset::CParseHandlerScalarLimitOffset(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
...
//
//---------------------------------------------------------------------------
void CParseHandlerScalarLimitOffset::StartElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
  ...
  if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenScalarLimitOffset), element_local_name)) {
    ...
    CDXLScalarLimitOffset *dxl_op = (CDXLScalarLimitOffset *)CDXLOperatorFactory::MakeDXLLimitOffset(
...
//
//---------------------------------------------------------------------------
void CParseHandlerScalarLimitOffset::EndElement(const XMLCh *const,  // element_uri,
