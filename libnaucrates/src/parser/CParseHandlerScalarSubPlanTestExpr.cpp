...
CParseHandlerScalarSubPlanTestExpr::CParseHandlerScalarSubPlanTestExpr(CMemoryPool *mp,
    ...
    : CParseHandlerScalarOp(mp, parse_handler_mgr, parse_handler_root), m_dxl_test_expr(nullptr) {}
...
//
//---------------------------------------------------------------------------
void CParseHandlerScalarSubPlanTestExpr::StartElement(const XMLCh *const element_uri,
...
//
//---------------------------------------------------------------------------
void CParseHandlerScalarSubPlanTestExpr::EndElement(const XMLCh *const,  // element_uri,
                                                    const XMLCh *const element_local_name,
