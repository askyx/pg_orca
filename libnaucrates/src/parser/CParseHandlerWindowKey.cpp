...
CParseHandlerWindowKey::CParseHandlerWindowKey(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
    ...
    : CParseHandlerBase(mp, parse_handler_mgr, parse_handler_root), m_dxl_window_key_gen(nullptr) {}
...
//
//---------------------------------------------------------------------------
void CParseHandlerWindowKey::StartElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
...
//
//---------------------------------------------------------------------------
void CParseHandlerWindowKey::EndElement(const XMLCh *const,  // element_uri,
