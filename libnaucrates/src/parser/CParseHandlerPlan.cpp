...
//
//---------------------------------------------------------------------------
CParseHandlerPlan::CParseHandlerPlan(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
...
//
//---------------------------------------------------------------------------
CDXLNode *CParseHandlerPlan::CreateDXLNode() {
  return m_dxl_node;
}
...
//
//---------------------------------------------------------------------------
EDxlParseHandlerType CParseHandlerPlan::GetParseHandlerType() const {
  return EdxlphPlan;
}
...
//
//---------------------------------------------------------------------------
void CParseHandlerPlan::StartElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
  ...
  m_plan_id = CDXLOperatorFactory::ConvertAttrValueToUllong(m_parse_handler_mgr->GetDXLMemoryManager(), xml_str_plan_id,
  ...
  m_plan_space_size = CDXLOperatorFactory::ConvertAttrValueToUllong(
      m_parse_handler_mgr->GetDXLMemoryManager(), xmlszPlanSpaceSize, EdxltokenPlanSpaceSize, EdxltokenPlan);
...
//
//---------------------------------------------------------------------------
void CParseHandlerPlan::EndElement(const XMLCh *const,  // element_uri,
