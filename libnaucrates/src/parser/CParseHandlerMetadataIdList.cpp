...
//
//---------------------------------------------------------------------------
CParseHandlerMetadataIdList::CParseHandlerMetadataIdList(CMemoryPool *mp, CParseHandlerManager *parse_handler_mgr,
                                                         CParseHandlerBase *parse_handler_root)
    : CParseHandlerBase(mp, parse_handler_mgr, parse_handler_root), m_mdid_array(nullptr) {}
...
//
//---------------------------------------------------------------------------
void CParseHandlerMetadataIdList::StartElement(const XMLCh *const,  // element_uri,
  ...
  if (FSupportedListType(element_local_name)) {
    ...
    IMDId *mdid = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(m_parse_handler_mgr->GetDXLMemoryManager(), attrs,
                                                                     EdxltokenMdid, EdxltokenPartition);
    m_mdid_array->Append(mdid);
    ...
    IMDId *mdid = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(m_parse_handler_mgr->GetDXLMemoryManager(), attrs,
                                                                     EdxltokenMdid, EdxltokenOpfamily);
    m_mdid_array->Append(mdid);
    ...
    IMDId *mdid = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(m_parse_handler_mgr->GetDXLMemoryManager(), attrs,
                                                                     EdxltokenMdid, EdxltokenRelDistrOpfamily);
    m_mdid_array->Append(mdid);
  } else if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenRelDistrOpclass), element_local_name)) {
    // distr opclass metadata id: array must be initialized already
    GPOS_ASSERT(nullptr != m_mdid_array);

    IMDId *mdid = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(m_parse_handler_mgr->GetDXLMemoryManager(), attrs,
                                                                     EdxltokenMdid, EdxltokenRelDistrOpclass);
    m_mdid_array->Append(mdid);
  } else {
    CWStringDynamic *str =
...
//
//---------------------------------------------------------------------------
void CParseHandlerMetadataIdList::EndElement(const XMLCh *const,  // element_uri,
                                             const XMLCh *const element_local_name,
                                             const XMLCh *const  // element_qname
) {
  if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPartitions), element_local_name) ||
      ...
      0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenRelDistrOpclasses), element_local_name)) {
...
//
//---------------------------------------------------------------------------
BOOL CParseHandlerMetadataIdList::FSupportedElem(const XMLCh *const xml_str) {
  return (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenIndex), xml_str) ||
          ...
          0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenRelDistrOpclass), xml_str));
}
...
//
//---------------------------------------------------------------------------
BOOL CParseHandlerMetadataIdList::FSupportedListType(const XMLCh *const xml_str) {
  return (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPartitions), xml_str) ||
          ...
          0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenRelDistrOpclasses), xml_str));
}
...
//
//---------------------------------------------------------------------------
IMdIdArray *CParseHandlerMetadataIdList::GetMdIdArray() {
  return m_mdid_array;
}
// EOF
