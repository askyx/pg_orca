...
void CParseHandlerScalarValuesList::StartElement(const XMLCh *const element_uri, const XMLCh *const element_local_name,
...
void CParseHandlerScalarValuesList::EndElement(const XMLCh *const,  // element_uri,
