...
void CDXLTokens::Init(CMemoryPool *mp) {
  ...
  SWszMapElem rgStrMap[] = {
      ...
      {EdxltokenPhysicalDynamicForeignScan, GPOS_WSZ_LIT("DynamicForeignScan")},
      ...
      {EdxltokenPhysicalDynamicIndexOnlyScan, GPOS_WSZ_LIT("DynamicIndexOnlyScan")},
      ...
      {EdxltokenScalarFieldSelectFieldCollation, GPOS_WSZ_LIT("FieldCollation")},
      ...
      {EdxltokenRelationExtendedStats, GPOS_WSZ_LIT("RelationExtendedStatistics")},
      ...
      {EdxltokenAssignedQueryIdForTargetRel, GPOS_WSZ_LIT("AssignedQueryIdForTargetRel")},
...
//
//---------------------------------------------------------------------------
const CWStringConst *CDXLTokens::GetDXLTokenStr(Edxltoken token_type) {
