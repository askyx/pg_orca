...
//
//---------------------------------------------------------------------------
void CXMLSerializer::StartDocument() {
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::OpenElement(const CWStringBase *pstrNamespace, const CWStringBase *elem_str) {
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::CloseElement(const CWStringBase *pstrNamespace, const CWStringBase *elem_str) {
  GPOS_ASSERT(nullptr != elem_str);
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, const CWStringBase *str_value) {
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, const CHAR *szValue) {
  GPOS_ASSERT(nullptr != pstrAttr);
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, ULONG ulValue) {
  GPOS_ASSERT(nullptr != pstrAttr);
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, ULLONG ullValue) {
  GPOS_ASSERT(nullptr != pstrAttr);
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, INT iValue) {
  GPOS_ASSERT(nullptr != pstrAttr);
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, LINT value) {
  GPOS_ASSERT(nullptr != pstrAttr);
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, CDouble value) {
  GPOS_ASSERT(nullptr != pstrAttr);
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, BOOL fValue) {
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::WriteEscaped(IOstream &os, const CWStringBase *str) {
...
//
//---------------------------------------------------------------------------
void CXMLSerializer::AddAttribute(const CWStringBase *pstrAttr, BOOL is_null, const BYTE *data, ULONG length) {
  if (!is_null) {
